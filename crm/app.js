var Ja=Object.defineProperty;var O=(t,e)=>()=>(t&&(e=t(t=0)),e);var Z=(t,e)=>{for(var n in e)Ja(t,n,{get:e[n],enumerable:!0})};var le,ke,ce,kt,de=O(()=>{le="https://fgzwcxwmaohowryzdgui.supabase.co",ke="sb_publishable_QYbHrEJ06GpGDMlIqf5tzw_ijJpdtTV",ce="kingson-files",kt="Africa/Harare"});function Un(){try{let t=localStorage.getItem(nn);G=t?JSON.parse(t):null}catch{G=null}return G}function sn(){return G}function Lt(t){G=t;try{t?localStorage.setItem(nn,JSON.stringify(t)):localStorage.removeItem(nn)}catch{}return t}function pe(t,e){let n=e?.code||"",a=e?.message||e?.error_description||e?.msg||"";return n==="23505"?/contacts_email_key/.test(a)?"A contact with that email address already exists.":/companies_name_key/.test(a)?"A company with that name already exists.":"That record already exists.":n==="23514"?/lost_has_reason/.test(a)?"A lost opportunity needs a reason.":/quotes_sent_has_date/.test(a)?"A quotation marked sent needs the date it went out.":/contacts_reachable/.test(a)?"A contact needs a phone number, a WhatsApp number or an email address.":/amount_sane|value_sane/.test(a)?"That amount cannot be negative.":"That value is not allowed here.":n==="23503"?"That record is still attached to something else.":t===401?"Your session has expired. Sign in again.":t===403||n==="42501"?"You do not have permission to do that.":t===404?"That record no longer exists.":t===0?"No connection. Check the network and try again.":a||`Request failed (${t}).`}async function rn(t,{method:e="POST",body:n,token:a}={}){let s;try{s=await fetch(`${le}/auth/v1${t}`,{method:e,headers:{apikey:ke,"Content-Type":"application/json",...a?{Authorization:`Bearer ${a}`}:{}},body:n?JSON.stringify(n):void 0})}catch{throw new bt(pe(0),{status:0})}let i=await s.text(),r=i?JSON.parse(i):null;if(!s.ok)throw new bt(pe(s.status,r),{status:s.status,code:r?.code||""});return r}async function Fn(t,e){let n=await rn("/token?grant_type=password",{body:{email:t.trim(),password:e}});return Lt(In(n))}async function Wn(){let t=G;if(Lt(null),t?.access_token)try{await rn("/logout",{token:t.access_token})}catch{}}async function an(){if(!G?.refresh_token)throw new bt("Your session has expired. Sign in again.",{status:401});return Se||(Se=rn("/token?grant_type=refresh_token",{body:{refresh_token:G.refresh_token}}).then(t=>Lt(In(t))).catch(t=>{throw Lt(null),t}).finally(()=>{Se=null})),Se}function Xa(t,e){return Te.set(t,{at:Date.now(),promise:e}),e.catch(()=>Te.delete(t)),e}async function St(t,{method:e="GET",body:n,headers:a={},retry:s=!0}={}){if(Rn(e,a)){let i=Te.get(t);if(i&&Date.now()-i.at<Ya)return i.promise}else Te.clear();return Rn(e,a)?Xa(t,on(t,{method:e,headers:a,retry:s})):on(t,{method:e,body:n,headers:a,retry:s})}async function on(t,{method:e="GET",body:n,headers:a={},retry:s=!0}={}){if(G&&Bn())try{await an()}catch{}let i;try{i=await fetch(`${le}${t}`,{method:e,headers:{apikey:ke,"Content-Type":"application/json",...G?.access_token?{Authorization:`Bearer ${G.access_token}`}:{},...a},body:n===void 0?void 0:JSON.stringify(n)})}catch{throw new bt(pe(0),{status:0})}if(i.status===401&&s&&G?.refresh_token)try{return await an(),on(t,{method:e,body:n,headers:a,retry:!1})}catch{}let r=await i.text(),c=null;try{c=r?JSON.parse(r):null}catch{c=r}if(!i.ok)throw new bt(pe(i.status,c),{status:i.status,code:c?.code||"",details:c?.details||"",hint:c?.hint||""});return c}var nn,G,Se,In,Bn,bt,Ya,Te,Rn,f,qe,M,J,ln=O(()=>{de();nn="kingson-crm/session/v1",G=null,Se=null;In=t=>({access_token:t.access_token,refresh_token:t.refresh_token,expires_at:Date.now()+((t.expires_in||3600)-60)*1e3,user:t.user||null}),Bn=()=>!G||!G.expires_at||Date.now()>=G.expires_at,bt=class extends Error{constructor(e,{status:n=0,code:a="",details:s="",hint:i=""}={}){super(e),this.name="ApiError",this.status=n,this.code=a,this.details=s,this.hint=i}};Ya=2e3,Te=new Map,Rn=(t,e)=>t==="GET"&&!e.Prefer;f={select:(t,e="")=>St(`/rest/v1/${t}${e?"?"+e:""}`),count:async(t,e="")=>{let n=await St(`/rest/v1/${t}?select=id&limit=1${e?"&"+e:""}`,{headers:{Prefer:"count=exact"}});return Array.isArray(n)?n.length:0},insert:(t,e,n="")=>St(`/rest/v1/${t}${n?"?"+n:""}`,{method:"POST",body:e,headers:{Prefer:"return=representation"}}),update:(t,e,n)=>St(`/rest/v1/${t}?${e}`,{method:"PATCH",body:n,headers:{Prefer:"return=representation"}}),remove:(t,e)=>St(`/rest/v1/${t}?${e}`,{method:"DELETE",headers:{Prefer:"return=representation"}}),rpc:(t,e={})=>St(`/rest/v1/rpc/${t}`,{method:"POST",body:e})},qe={async upload(t,e,n){if(G&&Bn())try{await an()}catch{}let a;try{a=await fetch(`${le}/storage/v1/object/${t}/${encodeURI(e)}`,{method:"POST",headers:{apikey:ke,Authorization:`Bearer ${G?.access_token||""}`,"x-upsert":"false",...n.type?{"Content-Type":n.type}:{}},body:n})}catch{throw new bt(pe(0),{status:0})}if(!a.ok){let s=null;try{s=await a.json()}catch{}throw new bt(a.status===413?"That file is larger than the 25 MB limit.":s?.message||`Upload failed (${a.status}).`,{status:a.status})}return e},async signedUrl(t,e,n=120){let a=await St(`/storage/v1/object/sign/${t}/${encodeURI(e)}`,{method:"POST",body:{expiresIn:n}});return`${le}/storage/v1${a.signedURL||a.signedUrl}`},async remove(t,e){return St(`/storage/v1/object/${t}`,{method:"DELETE",body:{prefixes:e}})}},M=(t,e)=>`${t}=eq.${encodeURIComponent(e)}`,J=(t,e="asc",n=!0)=>`order=${t}.${e}${n?".nullslast":""}`});function Y(){return new Intl.DateTimeFormat("en-CA",{timeZone:kt}).format(new Date)}function q(t){if(!t)return null;let e=Date.parse(Y()+"T00:00:00Z"),n=Date.parse(String(t).slice(0,10)+"T00:00:00Z");return Number.isNaN(n)?null:Math.round((n-e)/864e5)}function Ee(t,e){let n=new Date(Date.parse(String(t).slice(0,10)+"T00:00:00Z"));return n.setUTCDate(n.getUTCDate()+e),n.toISOString().slice(0,10)}function Ae(t=Y(),e=1){let n=Ee(t,e);return new Date(n+"T00:00:00Z").getUTCDay()===0&&(n=Ee(n,1)),n}function lt(t){return!_t(t)||!t.next_action_due?!1:q(t.next_action_due)<0}function Ne(t){return!_t(t)||!t.next_action_due?!1:q(t.next_action_due)===0}function ct(t){if(!_t(t))return{level:"closed",label:nt[t.stage]?.name||"\u2014",sort:0};if(t.stage==="on_hold"&&t.hold_review_on&&q(t.hold_review_on)>0)return{level:"held",label:`On hold \xB7 review ${to(t.hold_review_on)}`,sort:50};if(Wt(t))return{level:"unbooked",label:"No next action",sort:900};let e=q(t.next_action_due);if(e<0){let n=Math.abs(e);return{level:"overdue",label:n===1?"1 day overdue":`${n} days overdue`,sort:1e3+n}}return e===0?{level:"today",label:"Due today",sort:800}:e<=7?{level:"soon",label:e===1?"Due tomorrow":`Due in ${e} days`,sort:700-e}:{level:"clear",label:`Due in ${e} days`,sort:100-Math.min(e,99)}}function Oe(t){return!_t(t)||!Number(t.live_quotes||0)?!1:!t.next_action_due||q(t.next_action_due)<0}function tt(t){return t?t.stage==="won"&&t.won_value!=null?{amount:Number(t.won_value),currency:t.currency||"USD",kind:"won"}:t.quoted_value!=null?{amount:Number(t.quoted_value),currency:t.quote_currency||t.currency||"USD",kind:t.quote_status==="draft"?"draft":"quoted"}:{amount:null,currency:t.currency||"USD",kind:"none"}:{amount:null,currency:"USD",kind:"none"}}function Nt(t,e=tt){let n={},a=0;for(let s of t){let i=e(s);i.amount!=null&&(n[i.currency]=(n[i.currency]||0)+i.amount,a++)}return{by:n,valued:a,unvalued:t.length-a}}async function Kn(t){let e;try{e=await t.rpc("enum_values",{enum_name:"opp_stage"})}catch{return{ok:!0,skipped:!0}}let n=new Set((e||[]).map(r=>typeof r=="string"?r:r.value)),a=new Set(ht.map(r=>r.id)),s=[...n].filter(r=>!a.has(r)),i=[...a].filter(r=>!n.has(r));return(s.length||i.length)&&console.error("[kingson] pipeline stages disagree with the database",{missingFromApp:s,notInDatabase:i}),{ok:!s.length&&!i.length,missing:s,extra:i}}var ht,nt,Hn,ue,De,At,Vn,Ce,Qn,cn,Gn,Ft,Le,zn,_t,Wt,to,dn,W=O(()=>{de();ht=[{id:"new",name:"New enquiry",short:"New",open:!0,group:"intake"},{id:"contacted",name:"Contacted",short:"Contacted",open:!0,group:"intake"},{id:"requirements",name:"Requirements / site visit",short:"Requirements",open:!0,group:"survey"},{id:"quoting",name:"Quote / BOQ preparing",short:"Quoting",open:!0,group:"quote"},{id:"quote_sent",name:"Quote sent",short:"Quote sent",open:!0,group:"quote"},{id:"followup",name:"Follow-up / awaiting decision",short:"Follow-up",open:!0,group:"chase"},{id:"on_hold",name:"On hold",short:"On hold",open:!0,group:"hold"},{id:"won",name:"Won",short:"Won",open:!1,group:"won"},{id:"lost",name:"Lost",short:"Lost",open:!1,group:"lost"}],nt=Object.fromEntries(ht.map(t=>[t.id,t])),Hn=ht.filter(t=>t.open).map(t=>t.id),ue=["low","normal","high","urgent"],De=["website","whatsapp","phone","email","referral","walk_in","other"],At={website:"Website",whatsapp:"WhatsApp",phone:"Phone",email:"Email",referral:"Referral",walk_in:"Walk-in",other:"Other"},Vn=["draft","sent","discussed","accepted","rejected","superseded","expired"],Ce={draft:"Draft",sent:"Sent",discussed:"Customer responded",accepted:"Accepted",rejected:"Not accepted",superseded:"Superseded",expired:"Expired"},Qn=[["price","Price"],["competitor","Went with a competitor"],["timing","Timing"],["project_cancelled","Project cancelled"],["scope_changed","Scope changed"],["no_response","No response"],["other","Other"]],cn=[["email","Email"],["whatsapp","WhatsApp"],["phone","Phone"],["meeting","Meeting"],["other","Other"]],Gn=["planning","in_progress","on_hold","complete","cancelled"],Ft={planning:"Planning",in_progress:"In progress",on_hold:"On hold",complete:"Complete",cancelled:"Cancelled"},Le={enquiry:"Enquiry",note:"Note",call:"Call",whatsapp:"WhatsApp",email:"Email",meeting:"Meeting",site_visit:"Site visit",quote:"Quotation",stage_change:"Stage change",task:"Task",file:"File",won:"Won",lost:"Lost",reply:"Customer reply",on_hold:"On hold",system:"System"},zn=["call","whatsapp","email","meeting","note"];_t=t=>!!(t&&nt[t.stage]?.open);Wt=t=>_t(t)&&!t.next_action_due;to=t=>new Date(String(t).slice(0,10)+"T12:00:00Z").toLocaleDateString("en-GB",{day:"numeric",month:"short",timeZone:"UTC"});dn=(t,e)=>t.reduce((n,a)=>n+(Number(e(a))||0),0)});function Ot(){try{return localStorage.getItem(un)==="1"}catch{return!1}}function ea(t){try{t?localStorage.setItem(un,"1"):localStorage.removeItem(un)}catch{}}var un,ao,dt,Me=O(()=>{un="kingson.showDemo";ao=()=>Ot()?"":"is_demo=eq.false",dt=t=>{let e=ao();return e?t?`${t}&${e}`:e:t}});var mn,na,oo,d,H=O(()=>{ln();de();W();Me();mn="*",na=J("next_action_due","asc"),oo=`stage=in.(${Hn.join(",")})`,d={profiles:()=>f.select("profiles",`select=*&${J("full_name")}`),me:t=>f.select("profiles",`select=*&${M("id",t)}`).then(e=>e[0]||null),opportunities:(t="")=>f.select("v_opportunity_state",dt(`select=${mn}${/(^|&)order=/.test(t)?"":"&"+na}${t?"&"+t:""}`)),openOpportunities:()=>f.select("v_opportunity_state",dt(`select=${mn}&${oo}&${na}`)),opportunity:t=>f.select("v_opportunity_state",`select=${mn}&${M("id",t)}`).then(e=>e[0]||null),createOpportunity:t=>f.insert("opportunities",t).then(e=>e[0]),updateOpportunity:(t,e)=>f.update("opportunities",M("id",t),e).then(n=>n[0]),setStage:(t,e)=>d.updateOpportunity(t,{stage:e}),recordQuote:(t,{amount:e,currency:n,preparedOn:a,validUntil:s,notes:i,reference:r,documentRef:c})=>f.rpc("record_quote",{p_opportunity_id:t,p_amount:e,p_currency:n||"USD",p_prepared_on:a||null,p_valid_until:s||null,p_notes:i||null,p_reference:r||null,p_document_ref:c||null}),markQuoteSent:(t,{sentAt:e,followUpOn:n,channel:a,notes:s})=>f.rpc("mark_quote_sent",{p_quote_id:t,p_sent_at:e||null,p_follow_up_on:n||null,p_channel:a||"email",p_notes:s||null}),logFollowUp:(t,{channel:e,notes:n,at:a,nextAction:s,nextDue:i})=>f.rpc("log_follow_up",{p_opportunity_id:t,p_channel:e,p_notes:n,p_at:a||null,p_next_action:s||null,p_next_due:i||null}),customerReplied:(t,{channel:e,notes:n,at:a})=>f.rpc("mark_customer_replied",{p_opportunity_id:t,p_channel:e,p_notes:n||null,p_at:a||null}),decide:(t,e,{on:n,value:a,reason:s,notes:i,reviewOn:r}={})=>f.rpc("decide_opportunity",{p_opportunity_id:t,p_outcome:e,p_on:n||null,p_value:a??null,p_reason:s||null,p_notes:i||null,p_review_on:r||null}),addWorkingDays:(t,e)=>f.rpc("add_working_days",{d:t,n:e}),settings:()=>f.select("crm_settings","select=*&limit=1").then(t=>t[0]||null),updateSettings:t=>f.update("crm_settings","id=eq.true",t).then(e=>e[0]),contacts:(t="")=>{let e=dt(`select=*,companies(id,name)&${J("full_name")}`);if(t){let n=encodeURIComponent(`%${t}%`);e+=`&or=(full_name.ilike.${n},email.ilike.${n},phone.ilike.${n},whatsapp.ilike.${n})`}return f.select("contacts",e)},contact:t=>f.select("contacts",`select=*,companies(id,name,kind,town)&${M("id",t)}`).then(e=>e[0]||null),createContact:t=>f.insert("contacts",t).then(e=>e[0]),updateContact:(t,e)=>f.update("contacts",M("id",t),e).then(n=>n[0]),companies:()=>f.select("companies",dt(`select=*&${J("name")}`)),company:t=>f.select("companies",`select=*&${M("id",t)}`).then(e=>e[0]||null),createCompany:t=>f.insert("companies",t).then(e=>e[0]),updateCompany:(t,e)=>f.update("companies",M("id",t),e).then(n=>n[0]),async findOrCreateCompany(t){let e=(t||"").trim();if(!e)return null;let n=await f.select("companies",`select=id,name&name=ilike.${encodeURIComponent(e)}&limit=1`);return n[0]?n[0]:d.createCompany({name:e})},activityFor:t=>f.select("activities",`select=*,profiles(full_name,initials)&${M("opportunity_id",t)}&${J("occurred_at","desc")}`),activityForContact:t=>f.select("activities",`select=*,profiles(full_name,initials),opportunities(id,ref,title)&${M("contact_id",t)}&${J("occurred_at","desc")}`),activityForProject:t=>f.select("activities",`select=*,profiles(full_name,initials)&${M("project_id",t)}&${J("occurred_at","desc")}`),recentActivity:(t=12)=>f.select("activities",dt(`select=*,profiles(full_name,initials),opportunities(id,ref,title)&${J("occurred_at","desc")}&limit=${t}`)),logActivity:t=>f.insert("activities",t).then(e=>e[0]),tasks:(t="")=>f.select("tasks",dt(`select=*,profiles!tasks_owner_id_fkey(full_name,initials),opportunities(id,ref,title,stage),contacts(id,full_name,phone,whatsapp,email)&${J("due_date")}${t?"&"+t:""}`)),openTasks:()=>d.tasks("status=eq.open"),tasksFor:t=>d.tasks(M("opportunity_id",t)),createTask:t=>f.insert("tasks",t).then(e=>e[0]),updateTask:(t,e)=>f.update("tasks",M("id",t),e).then(n=>n[0]),completeTask:t=>d.updateTask(t,{status:"done"}),visits:(t="")=>f.select("site_visits",dt(`select=*,profiles(full_name,initials),opportunities(id,ref,title,company_id,companies(name))&${J("scheduled_at")}${t?"&"+t:""}`)),upcomingVisits:()=>d.visits(`status=eq.scheduled&scheduled_at=gte.${new Date(Date.now()-864e5).toISOString()}`),visitsFor:t=>d.visits(M("opportunity_id",t)),createVisit:t=>f.insert("site_visits",t).then(e=>e[0]),updateVisit:(t,e)=>f.update("site_visits",M("id",t),e).then(n=>n[0]),quotes:(t="")=>f.select("quotes",dt(`select=*,profiles:sent_by(full_name,initials),opportunities(id,ref,title,stage,next_action_due,company_id,companies(name))&order=prepared_on.desc,version.desc${t?"&"+t:""}`)),liveQuotes:()=>d.quotes("status=in.(sent,discussed)"),quotesFor:t=>d.quotes(M("opportunity_id",t)),createQuote:t=>f.insert("quotes",t).then(e=>e[0]),updateQuote:(t,e)=>f.update("quotes",M("id",t),e).then(n=>n[0]),projects:(t="")=>f.select("projects",dt(`select=*,companies(id,name),contacts(id,full_name,phone,email),profiles(full_name,initials),opportunities(id,ref)&${J("created_at","desc")}${t?"&"+t:""}`)),project:t=>f.select("projects",`select=*,companies(id,name),contacts(id,full_name,phone,email,whatsapp),profiles(full_name,initials),opportunities(id,ref,title)&${M("id",t)}`).then(e=>e[0]||null),updateProject:(t,e)=>f.update("projects",M("id",t),e).then(n=>n[0]),convertToProject:(t,{name:e,startDate:n,targetDate:a}={})=>f.rpc("convert_to_project",{p_opportunity_id:t,p_name:e||null,p_start_date:n||null,p_target_date:a||null}),projectForOpportunity:t=>f.select("projects",`select=id,name,status&${M("opportunity_id",t)}`).then(e=>e[0]||null),enquiries:(t=50)=>f.select("enquiries",dt(`select=*&${J("created_at","desc")}&limit=${t}`)),filesFor:(t,e)=>f.select("files",`select=*,profiles(full_name,initials)&${M(t,e)}&${J("created_at","desc")}`),async uploadFile(t,e,n){let a=t.name.replace(/[^\w.\-]+/g,"_").slice(-80),s=`${Object.keys(e)[0].replace("_id","")}/${Object.values(e)[0]}/${Date.now()}-${a}`;await qe.upload(ce,s,t);try{return await f.insert("files",{bucket:ce,path:s,name:t.name,mime:t.type||null,size_bytes:t.size,uploaded_by:n||null,...e}).then(i=>i[0])}catch(i){try{await qe.remove(ce,[s])}catch{}throw i}},downloadUrl:t=>qe.signedUrl(ce,t,120),metrics:()=>f.rpc("dashboard_metrics",{p_include_demo:Ot()}),async dashboard(){let[t,e,n,a,s,i]=await Promise.all([d.metrics(),d.openOpportunities(),d.liveQuotes(),d.openTasks(),d.upcomingVisits(),d.recentActivity(10)]);return{metrics:t,open:e,liveQuotes:n,tasks:a,visits:s,recent:i}}}});function at(t,{empty:e="\u2014"}={}){let n=Object.entries(t||{}).filter(([,a])=>a!=null);return n.length?n.map(([a,s])=>L(s,a)).join(" \xB7 "):e}function aa(t){let e=Number(t);if(!Number.isFinite(e)||e===0)return t===0?"$0":"\u2014";let n=Math.abs(e);return n>=1e6?"$"+(e/1e6).toFixed(n%1e6?1:0)+"m":n>=1e3?"$"+(e/1e3).toFixed(n%1e3&&n<1e4?1:0)+"k":"$"+Math.round(e)}function Pe(t){let e=Object.entries(t||{}).filter(([,n])=>n!=null);return e.length?e.map(([n,a])=>n==="USD"?aa(a):`${n} ${aa(a).slice(1)}`).join(" \xB7 "):""}function qt(t){if(!t)return"";let e=Object.fromEntries(new Intl.DateTimeFormat("en-CA",{timeZone:kt,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hour12:!1}).formatToParts(new Date(t)).map(n=>[n.type,n.value]));return`${e.year}-${e.month}-${e.day}T${e.hour}:${e.minute}`}function me(t){return t?new Date(t+":00+02:00").toISOString():null}function A(t){if(!t)return"\u2014";let e=q(Tt(t));return e===null?"\u2014":e===0?"today":e===1?"tomorrow":e===-1?"yesterday":e>0?`in ${e} days`:`${-e} days ago`}function Re(t){let e=q(Tt(t));if(e===null||e>=0)return"";let n=Math.abs(e);return n===1?"1 day overdue":`${n} days overdue`}function ia(t,e=""){let n=String(t||"").replace(/\D/g,"");return n.length<9?"":`https://wa.me/${n}${e?"?text="+encodeURIComponent(e):""}`}var so,L,io,ro,lo,oa,j,Ht,ot,Tt,sa,v,o,ft,Et,I=O(()=>{de();W();so=new Intl.NumberFormat("en-US",{style:"currency",currency:"USD",maximumFractionDigits:0}),L=(t,e="USD")=>{if(t==null||t==="")return"\u2014";let n=Number(t);return Number.isFinite(n)?e==="USD"?so.format(n):`${e} ${n.toLocaleString("en-US",{maximumFractionDigits:0})}`:"\u2014"};io=new Intl.DateTimeFormat("en-GB",{day:"numeric",month:"short",timeZone:kt}),ro=new Intl.DateTimeFormat("en-GB",{day:"numeric",month:"short",year:"numeric",timeZone:kt}),lo=new Intl.DateTimeFormat("en-GB",{day:"numeric",month:"short",hour:"2-digit",minute:"2-digit",hour12:!1,timeZone:kt}),oa=t=>typeof t=="string"&&t.length===10?new Date(t+"T12:00:00Z"):new Date(t),j=t=>t?io.format(oa(t)):"\u2014",Ht=t=>t?ro.format(oa(t)):"\u2014",ot=t=>t?lo.format(new Date(t)):"\u2014",Tt=t=>t?typeof t=="string"&&t.length===10?t:new Intl.DateTimeFormat("en-CA",{timeZone:kt}).format(new Date(t)):"";sa=t=>String(t||"").split(/[\s.]+/).filter(Boolean).map(e=>e[0]).slice(0,2).join("").toUpperCase()||"?",v=(t,e,n)=>`${t} ${t===1?e:n||e+"s"}`,o=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),ft=t=>"tel:"+String(t||"").replace(/[^\d+]/g,"");Et=(t,e="",n="")=>{if(!t)return"";let a=[];return e&&a.push("subject="+encodeURIComponent(e)),n&&a.push("body="+encodeURIComponent(n)),`mailto:${t}${a.length?"?"+a.join("&"):""}`}});var S,l,Fs,Ws,z=O(()=>{S=(t,e=16)=>`<svg width="${e}" height="${e}" viewBox="0 0 24 24" fill="none" stroke="currentColor"
    ...
    </li>`}var $,he,x,la,fn,pt,po,Mt,uo,Vt,Qt,Pt,E,da,pa,Gt,Ie,K=O(()=>{I();W();z();$=(t,e,{note:n="",action:a="",tight:s=!1,id:i=""}={})=>`
  ...
  </div>`,pt=t=>`<div class="tbl-wrap">${t}</div>`;po=t=>t==="won"?`<span class="pill pill-won">${l.check(13)}Won</span>`:t==="lost"?`<span class="pill pill-lost">${l.cross(13)}Lost</span>`:`<span class="pill pill-quiet">${o(nt[t]?.name||t)}</span>`,Mt=t=>`<span class="src">${(l[uo[t]]||l.globe)(13)}${o(At[t]||t)}</span>`,uo={website:"globe",whatsapp:"whatsapp",phone:"phone",email:"mail",referral:"users",walk_in:"pin",other:"note"},Vt=t=>{let e=t==="accepted"?"won":t==="rejected"||t==="expired"||t==="superseded"?"lost":t==="draft"?"today":"quiet",n=t==="accepted"?l.check(13):t==="rejected"||t==="expired"||t==="superseded"?l.cross(13):l.doc(13);return`<span class="pill pill-${e}">${n}${o(Ce[t]||t)}</span>`},Qt=t=>`<span class="pill pill-${t==="complete"?"won":t==="cancelled"?"lost":t==="on_hold"?"today":"quiet"}">${o(Ft[t]||t)}</span>`,Pt=t=>t==="urgent"?`<span class="pill pill-overdue">${l.alert(13)}Urgent</span>`:t==="high"?'<span class="pill pill-today">High</span>':t==="low"?'<span class="pill pill-quiet">Low</span>':"",E=(t,e=26)=>t?`<span class="avatar" role="img" style="--s:${e}px" title="${o(t.full_name||"")}" aria-label="${o(t.full_name||"Assigned")}">${o(t.initials||sa(t.full_name))}</span>`:`<span class="avatar avatar-none" role="img" style="--s:${e}px" title="Unassigned" aria-label="Unassigned">?</span>`;da=t=>`
  <li class="feed-row">
    <span class="feed-ic">${(l[pa[t.kind]]||l.note)(14)}</span>
  ...
  </li>`,pa={enquiry:"bell",note:"note",call:"phone",whatsapp:"whatsapp",email:"mail",meeting:"users",site_visit:"pin",quote:"doc",stage_change:"move",task:"clock",file:"file",won:"check",lost:"cross",system:"refresh",reply:"mail",on_hold:"clock"},Gt=t=>t.length?`
  <ol class="timeline">
    ${t.map(e=>`
      <li class="tl">
        <span class="tl-ic tl-${o(e.kind)}">${(l[pa[e.kind]]||l.note)(14)}</span>
        <span class="tl-body">
    ...
    </div>`,document.body.appendChild(c),document.body.classList.add("is-modal");let _=c.querySelector("form"),g=c.querySelector(".modal-err"),k=c.querySelector("[data-save]");(c.querySelector("input:not([type=hidden]), select, textarea")||k).focus();let rt=Q=>{if(Q.key==="Escape"){Q.preventDefault(),U();return}if(Q.key!=="Tab")return;let mt=[...c.querySelectorAll("input, select, textarea, button, [href]")].filter(It=>!It.disabled&&It.offsetParent!==null);if(!mt.length)return;let[X,Ut]=[mt[0],mt[mt.length-1]];Q.shiftKey&&document.activeElement===X?(Q.preventDefault(),Ut.focus()):!Q.shiftKey&&document.activeElement===Ut&&(Q.preventDefault(),X.focus())};function U(){document.removeEventListener("keydown",rt,!0),c.remove(),document.body.classList.remove("is-modal"),Be=null,r&&document.contains(r)&&r.focus()}return document.addEventListener("keydown",rt,!0),c.querySelector("[data-cancel]").addEventListener("click",U),c.addEventListener("mousedown",Q=>{Q.target===c&&U()}),_.addEventListener("submit",async Q=>{Q.preventDefault(),fo(c),g.hidden=!0,k.disabled=!0;let mt=k.textContent;k.textContent="Saving\u2026";try{await s(mo(_),c),U()}catch(X){X?.field?(ho(c,X.field,X.message),c.querySelector("#"+CSS.escape(X.field))?.focus()):(g.textContent=X?.message||"That could not be saved.",g.hidden=!1),k.disabled=!1,k.textContent=mt}}),Be=U,U}function R(t,...e){typeof t=="function"&&setTimeout(()=>{Promise.resolve(t(...e)).catch(n=>console.error("[kingson] refresh after save failed",n))},0)}var u,D,B,Kt,V,Rt,N,h,Zt,zt,Be,C,ut=O(()=>{I();z();u=(t,e,n,{hint:a="",wide:s=!1}={})=>`
  ...
  <select class="sel" id="${o(t)}" name="${o(t)}" ${a}>
  ...
  </select>`;h=t=>t===""||t===void 0?null:t,Zt=t=>t===""||t===null||t===void 0?null:Number(t);zt=null;Be=null;C=(t,e)=>Object.assign(new Error(e),{field:t})});var ua={};Z(ua,{render:()=>yo,sub:()=>go,title:()=>$o});async function yo(){let{metrics:t,open:e,liveQuotes:n,tasks:a,visits:s,recent:i}=await d.dashboard(),r=e.filter(lt),c=e.filter(Ne),_=e.filter(Wt),g=e.filter(m=>m.stage==="new"),k=e.filter(Oe),xt=t.won_count+t.lost_count,rt=xt?Math.round(t.won_count/xt*100):null,U=a.filter(m=>m.due_date&&q(m.due_date)<=0),Q=s.filter(m=>{let P=q(m.scheduled_at);return P!==null&&P>=0&&P<=7}),mt=`
    <div class="stats">
      ...
      ${he({label:"Not quoted yet",value:String(t.unquoted_count),tone:t.unquoted_count?"warn":"",foot:t.unquoted_count?"Open, with no quotation recorded":"Every open job has a quotation",href:"#/pipeline"})}
    ...
    </div>`,X=[...r,..._,...c,...g].filter((m,P,Ct)=>Ct.findIndex(en=>en.id===m.id)===P).sort((m,P)=>ct(P).sort-ct(m).sort).slice(0,12),Ut=$("Needs attention",X.length?`<ul class="att-list">${X.map(m=>ca(m)).join("")}</ul>`:x("Nothing is overdue and nothing is unbooked.","Every open opportunity has a next action with a date on it."),{note:"Overdue, unbooked, due today or unanswered \u2014 in any stage",tight:!0}),It=$("Today and the week ahead",`
    <div class="two-up">
      <div>
    ...
    </div>`,{note:`${v(Q.length,"visit")} \xB7 ${v(U.length,"task")}`}),ve=ht.filter(m=>m.open).map(m=>{let P=e.filter(en=>en.stage===m.id),Ct=Nt(P);return{s:m,n:P.length,value:Ct.by.USD||0,label:Pe(Ct.by)}}),Ye=Math.max(1,...ve.map(m=>m.value)),xe=$("Pipeline by stage",`
    <ul class="funnel">
      ${ve.map(m=>`
    ...
    <table class="tbl">
      ...
      <tbody>
        ${n.map(m=>{let P=m.opportunities,Ct=P&&!P.next_action_due;return`<tr${Ct?' class="tr-risk"':""}>
            <td><a class="lnk" href="#/opportunity/${o(P?.id||"")}">${o(m.reference)}${m.version>1?` <span class="rev">rev ${m.version}</span>`:""}</a></td>
            <td><span class="td-main">${o(P?.title||"\u2014")}</span><span class="td-sub">${o(P?.companies?.name||"")}</span></td>
            ...
            <td>${Ct?`<span class="pill pill-overdue">${l.alert(13)}No chase booked</span>`:q(P?.next_action_due)<0?`<span class="pill pill-overdue">${l.alert(13)}${o(j(P?.next_action_due))}</span>`:`<span class="pill pill-quiet">${o(j(P?.next_action_due))}</span>`}</td>
          </tr>`}).join("")}
      </tbody>
    </table>`):x("No quotations are out."),{note:k.length?`${v(k.length,"quotation")} overdue for a follow-up`:"Every one has a follow-up booked"}),Bt={};for(let m of e)Bt[m.source]=(Bt[m.source]||0)+1;let y=$("Where enquiries arrive",Object.keys(Bt).length?`
    <ul class="srcs">
      ${Object.entries(Bt).sort((m,P)=>P[1]-m[1]).map(([m,P])=>`<li class="srcs-row">${Mt(m)}<span class="srcs-n num">${P}</span></li>`).join("")}
    </ul>
    <p class="funnel-key">Open opportunities only. The website writes straight into this pipeline.</p>`:x("No open enquiries yet.","",{tone:"quiet"})),Za=$("Recent activity",i.length?`<ul class="feed">${i.map(da).join("")}</ul>`:x("Nothing logged yet.","",{tone:"quiet"}),{tight:!0});return`
    ${mt}
    <div class="grid grid-main">
      <div class="col-wide">${Ut}${It}${tn}</div>
      <div class="col-side">${xe}${Xe}${y}${Za}</div>
    </div>`}function go(){return`<span class="sub-quiet">${o(j(Y()))}</span>`}var $o,ma=O(()=>{H();W();I();K();z();$o="Dashboard"});async function ha(t=Y()){try{let e=await d.settings();return await d.addWorkingDays(t,e?.quote_followup_working_days??3)}catch{return""}}function fa({opp:t,quotes:e=[],onDone:n}){let a=(e.reduce((i,r)=>Math.max(i,r.version||0),0)||0)+1,s=e.find(i=>i.version===a-1);F({title:a>1?`Record revision ${a}`:"Record the quotation",sub:`${t.ref} \u2014 ${t.title}`,width:580,submitLabel:"Record quotation",body:`
      <div class="field-row">
        ...
        ${u("currency","Currency",N("currency",bo,s?.currency||t.currency||"USD"))}
      </div>
      <div class="field-row">
      ...
      <p class="modal-message">Recorded as a draft. Use <strong>Mark as sent</strong> once it has
        actually gone to the customer \u2014 that is what starts the follow-up clock.</p>`,onSubmit:async i=>{let r=Zt(i.amount);if(r===null||Number.isNaN(r))throw C("amount","Enter the quoted amount.");if(r<0)throw C("amount","That cannot be negative.");let c=await d.recordQuote(t.id,{amount:r,currency:i.currency,preparedOn:h(i.prepared_on),validUntil:h(i.valid_until),notes:h(i.notes),reference:h(i.reference),documentRef:h(i.document_ref)});b(`Quotation ${c?.reference||""} recorded.`),R(n,c)}})}async function Fe({opp:t,quote:e,onDone:n}){let a=await ha(),s=qt(new Date);F({title:`Mark ${e.reference} as sent`,sub:`${L(e.amount,e.currency)} \xB7 ${t.title}`,width:540,submitLabel:"Mark as sent",body:`
      <div class="field-row">
      ...
      ${u("notes","Notes",B("notes",e.notes||"",3),{wide:!0})}`,onSubmit:async s=>{let i={valid_until:h(s.valid_until),document_ref:h(s.document_ref),notes:h(s.notes)};if(a){let r=Zt(s.amount);if(r===null||Number.isNaN(r)||r<0)throw C("amount","Enter a valid amount.");i.amount=r}await d.updateQuote(e.id,i),b("Quotation saved."),R(n)}})}async function He({opp:t,onDone:e}){let n=await ha(),a=qt(new Date);F({title:"Log a follow-up",sub:`${t.ref} \u2014 ${t.title}`,width:560,submitLabel:"Log follow-up",body:`
      <div class="field-row">
      ...
      <p class="modal-message">If the customer answered, use <strong>Customer replied</strong>
        instead \u2014 that stops the chase and puts the next move on us.</p>`,onSubmit:async s=>{if(!s.notes)throw C("notes","Say what happened.");if(!s.next_due)throw C("next_due","Give the next date.");await d.logFollowUp(t.id,{channel:s.channel,notes:s.notes,at:$n(s.at,a),nextAction:h(s.next_action),nextDue:s.next_due}),b("Follow-up logged."),R(e)}})}function $a({opp:t,onDone:e}){let n=qt(new Date);F({title:"Customer replied",sub:`${t.ref} \u2014 ${t.title}`,width:520,submitLabel:"Record reply",body:`
      <div class="field-row">
      ...
      <p class="modal-message">Recorded by hand \u2014 the CRM cannot see Kingson's inbox. The
        chase stops and the next action becomes "Respond to customer reply", due today.</p>`,onSubmit:async a=>{await d.customerReplied(t.id,{channel:a.channel,notes:h(a.notes),at:$n(a.at,n)}),b("Reply recorded."),R(e)}})}function yn({opp:t,onDone:e,onCancel:n}){let a=tt(t);F({title:"Mark as won",sub:`${t.ref} \u2014 ${t.title}`,width:500,submitLabel:"Mark won",body:`
      <div class="field-row">
      ...
      <p class="modal-message">Everything on the record is kept. Nothing is chased until the review date.</p>`,onSubmit:async a=>{if(!a.reason)throw C("reason","Give a reason.");if(!a.review_on)throw C("review_on","Choose a review date.");if(a.review_on<Y())throw C("review_on","That date has passed.");await d.decide(t.id,"on_hold",{reason:a.reason,reviewOn:a.review_on,notes:h(a.notes)}),b("On hold."),R(e)}}),_n(n)}function Ve(t,{opp:e,onDone:n,onCancel:a}){return t==="won"?(yn({opp:e,onDone:n,onCancel:a}),!0):t==="lost"?(gn({opp:e,onDone:n,onCancel:a}),!0):t==="on_hold"?(bn({opp:e,onDone:n,onCancel:a}),!0):!1}function _n(t){if(typeof t!="function")return;let e=document.querySelector(".modal");if(!e)return;let n=new MutationObserver(()=>{document.body.contains(e)||(n.disconnect(),t())});n.observe(document.body,{childList:!0})}var bo,$n,_o,fe=O(()=>{H();W();I();ut();bo=["USD","ZWG","ZAR"];$n=(t,e)=>t===e?null:me(t),_o=`
  <p class="modal-message">The CRM does not send email. Send the quotation from your own
    ...
    stamped on the record.</p>`});var ya={};Z(ya,{actions:()=>To,mount:()=>ko,render:()=>vo,sub:()=>So,title:()=>wo});async function vo(){let[t,e]=await Promise.all([d.openOpportunities(),d.opportunities("stage=in.(won,lost)&order=decided_at.desc&limit=40")]);Jt=[...t,...e];let n=Jt;return n.length?`
  <div class="board" role="list">
    ${ht.map(a=>{let s=n.filter(c=>c.stage===a.id),i=Pe(Nt(s).by),r=s.filter(lt).length;return`
      <section class="col" data-group="${o(a.group)}" data-stage="${o(a.id)}" role="listitem">
        ...
        <div class="col-body" data-drop="${o(a.id)}">
          ${s.length?s.sort((c,_)=>ct(_).sort-ct(c).sort).map(xo).join(""):'<p class="col-empty">Nothing here</p>'}
        </div>
      </section>`}).join("")}
  </div>`:x("No opportunities yet.","An enquiry from the website appears here automatically. You can also add one by hand.",{tone:"quiet"})}function xo(t){let e=ct(t);return`
  <article class="deal${e.level==="overdue"||e.level==="unbooked"?" deal-alarm":""}" draggable="true" data-deal="${o(t.id)}">
      ...
      <span class="deal-right">
        ...
        <span class="deal-move">
          ...
          <select class="deal-select" id="mv-${o(t.id)}" data-move="${o(t.id)}">
            ${ht.map(a=>`<option value="${o(a.id)}"${a.id===t.stage?" selected":""}>${o(a.short)}</option>`).join("")}
          </select>
          <span class="deal-move-ic" aria-hidden="true">${l.chevron(12)}</span>
        </span>
      </span>
    </div>
  </article>`}function ko(t,e){async function n(s,i,r){let c=Jt.find(g=>g.id===s)||{id:s,title:"this opportunity",stage:r};if(c.stage===i)return;let _=t.querySelector(`[data-move="${CSS.escape(s)}"]`);if(!Ve(i,{opp:c,onDone:e,onCancel:()=>{_&&document.contains(_)&&r&&(_.value=r)}}))try{await d.setStage(s,i),b(`Moved to ${nt[i].name}.`),await e()}catch(g){b(g.message||"That move could not be saved.","bad");let k=t.querySelector(`[data-move="${CSS.escape(s)}"]`);k&&r&&(k.value=r)}}t.addEventListener("change",s=>{let i=s.target.closest("[data-move]");if(!i)return;let r=i.dataset.move,c=Jt.find(_=>_.id===r)?.stage;n(r,i.value,c)});let a=null;t.addEventListener("dragstart",s=>{let i=s.target.closest("[data-deal]");if(i){a=i.dataset.deal,i.classList.add("is-dragging"),s.dataTransfer.effectAllowed="move";try{s.dataTransfer.setData("text/plain",a)}catch{}}}),t.addEventListener("dragend",s=>{s.target.closest("[data-deal]")?.classList.remove("is-dragging"),t.querySelectorAll(".is-over").forEach(i=>i.classList.remove("is-over")),a=null}),t.addEventListener("dragover",s=>{let i=s.target.closest("[data-drop]");!i||!a||(s.preventDefault(),s.dataTransfer.dropEffect="move",i.classList.contains("is-over")||(t.querySelectorAll(".is-over").forEach(r=>r.classList.remove("is-over")),i.classList.add("is-over")))}),t.addEventListener("drop",s=>{let i=s.target.closest("[data-drop]");if(!i||!a)return;s.preventDefault();let r=a;a=null,n(r,i.dataset.drop,Jt.find(c=>c.id===r)?.stage)})}function So(){let t=Jt.filter(n=>nt[n.stage]?.open),e=Nt(t);return`${o(v(t.length,"open opportunity","open opportunities"))} \xB7 <span class="num">${o(at(e.by,{empty:"nothing quoted"}))}</span>${e.unvalued?` \xB7 ${e.unvalued} not quoted yet`:""}`}var wo,Jt,To,ga=O(()=>{H();W();I();K();z();ut();fe();wo="Pipeline",Jt=[];To=()=>`<button type="button" class="btn btn-sm" data-new-opp>${l.plus(14)}<span>New opportunity</span></button>`});var ba={};Z(ba,{mount:()=>Do,render:()=>Eo,sub:()=>Co,title:()=>qo});function Qe(t){let e=Nt(t);return e.valued?at(e.by)+" quoted"+(e.unvalued?` \xB7 ${e.unvalued} unquoted`:""):t.length?"not quoted yet":""}async function Eo(t,{me:e}){Dt=await d.openOpportunities();let n=Dt.filter(lt).sort((c,_)=>q(c.next_action_due)-q(_.next_action_due)),a=Dt.filter(Wt).sort((c,_)=>new Date(c.created_at)-new Date(_.created_at)),s=Dt.filter(Ne),i=Dt.filter(c=>{let _=q(c.next_action_due);return _!==null&&_>0&&_<=14}).sort((c,_)=>q(c.next_action_due)-q(_.next_action_due));return`
    ${`
    ...
    <ul class="fu-list">
      ${e.map(a=>`
        <li class="fu">
          ...
          <span class="fu-stage">${jt(a)}</span>
          <span class="fu-owner">${E(a.owner_name?{full_name:a.owner_name,initials:a.owner_initials}:null,26)}</span>
          <span class="fu-do">
            ${$t({phone:a.contact_phone,whatsapp:a.contact_whatsapp,email:a.contact_email},{text:`Good day, Kingson Engineering here regarding ${a.title}.`,size:"xs"})}
            <button type="button" class="btn-ghost btn-xs" data-chase="${o(a.id)}">${l.check(13)}<span>Log follow-up</span></button>
          </span>
        </li>`).join("")}
    </ul>`,{note:n,tight:!0}):$(t,x(t==="Overdue"||t.startsWith("Open,")?"Nothing in this group. Good.":"Nothing booked in this window."),{note:n,tight:!0})}function Do(t,e){t.addEventListener("click",n=>{let a=n.target.closest("[data-chase]");if(!a)return;let s=Dt.find(i=>i.id===a.dataset.chase);s&&He({opp:s,onDone:e})})}function Co(){let t=Dt.filter(lt).length,e=Dt.filter(Wt).length,n=[];return t&&n.push(`${t} overdue`),e&&n.push(`${e} with nothing booked`),n.length?`<span class="sub-alarm">${l.alert(14)}${o(n.join(" \xB7 "))}</span>`:"Nothing is late"}var qo,Dt,_a=O(()=>{H();W();I();K();z();ut();fe();qo="Follow-ups";Dt=[]});var ze={};Z(ze,{bookFollowUp:()=>kn,contactDialog:()=>Sn,convertDialog:()=>Tn,logActivity:()=>xn,newOpportunity:()=>vn,projectDialog:()=>qn,taskDialog:()=>ye,visitDialog:()=>Yt});async function vn({me:t,contact:e=null,onDone:n}){let a=await d.profiles();F({title:"New opportunity",sub:e?`For ${e.full_name}`:"A job somebody has asked about",width:620,submitLabel:"Create",body:`
      <div class="field-row">
      ...
      <div class="field-row">
        ...
        ${u("source","How did it come in?",N("source",De.map(s=>[s,At[s]]),"phone"))}
      </div>
      ${u("location","Site",D("location","",'placeholder="Msasa, Harare"'),{wide:!0})}
      <div class="field-row">
        ${u("owner_id","Owner",N("owner_id",$e(a),t?.id||""))}
        ${u("priority","Priority",N("priority",ue.map(s=>[s,wn(s)]),"normal"))}
      </div>
      <div class="field-row">
      ...
      <p class="modal-message">The client, contact, value and description come across from the
        opportunity. The opportunity stays on record and links to the project.</p>`,onSubmit:async n=>{let a=await d.convertToProject(t.id,{name:n.name,startDate:h(n.start_date),targetDate:h(n.target_date)});b("Project opened."),e?R(e,a):location.hash=`#/project/${a}`}})}async function qn({project:t,me:e,onDone:n}){let a=await d.profiles();F({title:"Edit project",sub:t.name,width:560,submitLabel:"Save",body:`
      ${u("name","Name",D("name",t.name,"required"),{wide:!0})}
      <div class="field-row">
        ${u("status","Status",N("status",Gn.map(s=>[s,Ft[s]]),t.status))}
        ${u("owner_id","Responsible",N("owner_id",$e(a),t.owner_id||""))}
      </div>
      <div class="field-row">
        ${u("start_date","Start",V("start_date",Tt(t.start_date)))}
        ${u("target_date","Target",V("target_date",Tt(t.target_date)))}
      </div>
      <div class="field-row">
        ${u("value","Value (USD)",Kt("value",t.value??"",'min="0" step="100"'))}
        ${u("completed_on","Completed",V("completed_on",Tt(t.completed_on)))}
      </div>
      ${u("description","Description",B("description",t.description||"",3),{wide:!0})}
      ${u("notes","Notes",B("notes",t.notes||"",2),{wide:!0})}`,onSubmit:async s=>{if(!s.name)throw C("name","A project needs a name.");await d.updateProject(t.id,{name:s.name,status:s.status,owner_id:h(s.owner_id),start_date:h(s.start_date),target_date:h(s.target_date),completed_on:h(s.completed_on),value:Zt(s.value),description:h(s.description),notes:h(s.notes)}),b("Project saved."),R(n)}})}var wn,$e,yt=O(()=>{H();W();I();ut();wn=t=>t.charAt(0).toUpperCase()+t.slice(1),$e=(t,e=!0)=>(e?[["","Unassigned"]]:[]).concat(t.map(n=>[n.id,n.full_name]))});var xa={};Z(xa,{actions:()=>Mo,mount:()=>Oo,render:()=>Ao,sub:()=>jo,title:()=>Lo});async function Ao(t,{me:e}){return[Ke,wa]=await Promise.all([d.tasks(),d.profiles()]),va(e)}function va(t){let e=Ke.filter(s=>(st.status==="all"||s.status===st.status)&&(st.owner==="all"||(st.owner==="mine"?s.owner_id===t?.id:s.owner_id===st.owner))),n=`
    <div class="filters">
      ...
      <select class="sel sel-inline" id="f-owner" data-f="owner">
        ...
        ${wa.map(s=>`<option value="${o(s.id)}"${st.owner===s.id?" selected":""}>${o(s.full_name)}</option>`).join("")}
      </select>
    ...
    <ul class="fu-list">
      ${e.sort(No).map(s=>`
        <li class="fu${s.status==="done"?" is-done":""}">
          ...
          <span class="fu-stage">${Pt(s.priority)}</span>
    ...
    </ul>`:x(st.status==="open"?"Nothing outstanding.":"No tasks match that filter.",st.status==="open"?"Every task on this filter is done.":"",{tone:"ok"});return n+$("",a,{tight:!0})}function Oo(t,e,{me:n}){t.addEventListener("change",a=>{let s=a.target.closest("[data-f]");if(!s)return;st[s.dataset.f]=s.value;let i=document.getElementById("view");i.innerHTML=va(n)}),t.addEventListener("click",async a=>{let s=a.target.closest("[data-done]"),i=a.target.closest("[data-reopen]"),r=a.target.closest("[data-edit]");try{if(s)return await d.completeTask(s.dataset.done),b("Completed."),e();if(i)return await d.updateTask(i.dataset.reopen,{status:"open"}),b("Reopened."),e();if(r){let c=Ke.find(_=>_.id===r.dataset.edit);if(c)return ye({task:c,me:n,onDone:e})}}catch(c){b(c.message||"That could not be saved.","bad")}})}function jo(){let t=Ke.filter(n=>n.status==="open"),e=t.filter(n=>n.due_date&&q(n.due_date)<0).length;return e?`<span class="sub-alarm">${l.alert(14)}${o(v(e,"task"))} overdue</span>`:`${o(v(t.length,"open task"))}`}var Lo,Ke,st,wa,No,Mo,ka=O(()=>{H();W();I();K();z();ut();yt();Lo="Tasks",Ke=[],st={status:"open",owner:"all"},wa=[];No=(t,e)=>t.due_date?e.due_date?t.due_date<e.due_date?-1:t.due_date>e.due_date?1:0:-1:1;Mo=()=>`<button type="button" class="btn btn-sm" data-new-task-global>${l.plus(14)}<span>New task</span></button>`});var Ta={};Z(Ta,{actions:()=>Bo,mount:()=>Uo,render:()=>Ro,sub:()=>Io,title:()=>Po});async function Ro(){return Xt=await d.contacts(),`
    <div class="filters">
      <div class="search">
        ${l.search(15)}
    ...
    <div data-list>${Sa(Xt)}</div>`}function Sa(t){return t.length?$("",pt(`
    <table class="tbl tbl-rows">
      ...
      <tbody>
        ${t.map(e=>`<tr>
          ...
          <td class="num">${e.phone?`<a class="lnk" href="${o(ft(e.phone))}">${o(e.phone)}</a>`:"\u2014"}</td>
          <td>${o(e.email||"\u2014")}</td>
          <td class="ta-r">${$t(e,{size:"xs"})}</td>
        </tr>`).join("")}
      </tbody>
    </table>`),{tight:!0}):$("",x("No contacts match that.","Try part of a name, a company or a number.",{tone:"quiet"}),{tight:!0})}function Uo(t){let e=t.querySelector("#c-search"),n=t.querySelector("[data-list]"),a=t.querySelector("[data-count]"),s=null;e?.addEventListener("input",()=>{En=e.value.trim(),clearTimeout(s),s=setTimeout(()=>{let i=En.toLowerCase(),r=i?Xt.filter(c=>[c.full_name,c.companies?.name,c.phone,c.whatsapp,c.email,c.job_title].some(_=>String(_||"").toLowerCase().includes(i))):Xt;n.innerHTML=Sa(r),a.textContent=v(r.length,"contact")},120)})}var Po,Xt,En,Io,Bo,qa=O(()=>{H();I();K();z();yt();Po="Contacts",Xt=[],En="";Io=()=>v(Xt.length,"contact"),Bo=()=>`<button type="button" class="btn btn-sm" data-new-contact>${l.plus(14)}<span>New contact</span></button>`});function ee(t,e,n,a){t.addEventListener("change",async s=>{let i=s.target.closest("[data-upload]");if(!i||!i.files?.length)return;let r=i.files[0];if(i.value="",r.size>Fo){b(`${r.name} is ${Ea(r.size)}. The limit is 25 MB \u2014 send larger drawing sets by transfer link.`,"bad");return}let c=t.querySelector(".file-pick span"),_=c?.textContent;c&&(c.textContent="Uploading\u2026");try{let g=await d.uploadFile(r,e,n?.id);await d.logActivity({opportunity_id:e.opportunity_id||null,project_id:e.project_id||null,contact_id:e.contact_id||null,kind:"file",body:`File added: ${r.name}`,actor_id:n?.id||null}),b("Uploaded."),R(a)}catch(g){b(g.message||"That file could not be uploaded.","bad"),c&&(c.textContent=_)}}),t.addEventListener("click",async s=>{let i=s.target.closest("[data-file]");if(!i)return;let r=i.dataset.name||"file",c=i.parentElement?.querySelector(".mini-side"),_=c?.innerHTML;c&&(c.textContent="\u2026");try{let g=await d.downloadUrl(i.dataset.file),k=await fetch(g);if(!k.ok)throw new Error(`That file could not be fetched (${k.status}).`);let xt=await k.blob(),rt=URL.createObjectURL(xt),U=document.createElement("a");U.href=rt,U.download=r,U.rel="noopener",document.body.appendChild(U),U.click(),U.remove(),setTimeout(()=>URL.revokeObjectURL(rt),3e4)}catch(g){b(g.message||"That file could not be opened.","bad")}finally{c&&_!==void 0&&(c.innerHTML=_)}})}var Fo,Ea,te,Ze=O(()=>{H();I();K();z();ut();Fo=25*1024*1024,Ea=t=>!t&&t!==0?"":t>=1048576?(t/1048576).toFixed(1)+" MB":t>=1024?Math.round(t/1024)+" KB":t+" B",te=t=>$("Files",t.length?`
  <ul class="mini files">
    ${t.map(e=>`<li>
      <button type="button" class="mini-btn" data-file="${o(e.path)}" data-name="${o(e.name)}">
        <span class="mini-main">${l.file(13)}${o(e.name)}</span>
        <span class="mini-sub">${o(Ea(e.size_bytes))} \xB7 ${o(j(e.created_at))}${e.profiles?.initials?" \xB7 "+o(e.profiles.initials):""}</span>
      </button>
    ...
    <div class="contact">
      ...
      <div class="contact-body">
        ...
        <div class="contact-lines">
          ${T.phone?`<a class="lnk" href="${o(ft(T.phone))}">${l.phone(13)}${o(T.phone)}</a>`:""}
          ${T.whatsapp&&T.whatsapp!==T.phone?`<span class="lnk-plain">${l.whatsapp(13)}${o(T.whatsapp)}</span>`:""}
          ${T.email?`<a class="lnk" href="${o(Et(T.email))}">${l.mail(13)}${o(T.email)}</a>`:""}
        </div>
        ${T.preferred_channel?`<p class="contact-pref">Prefers ${o(T.preferred_channel)}</p>`:""}
      </div>
    </div>
    <div class="contact-acts">${$t(T,{text:`Good day ${T.full_name.split(" ")[0]}, Kingson Engineering here.`})}</div>
    ...
    <ul class="mini">
      ${n.map(g=>`<li>
        <a href="#/opportunity/${o(g.id)}">
          <span class="mini-main">${o(g.title)} ${jt(g)}</span>
    ...
    </ul>`:x("No enquiries recorded.","",{tone:"quiet"}),{tight:!0,note:v(n.length,"enquiry","enquiries"),action:`<button type="button" class="btn-ghost btn-xs" data-new-opp-for>${l.plus(13)}<span>New</span></button>`}),_=$("Quotations",i.length?`
    <ul class="quotes">
    ...
    <div class="grid grid-opp">
      ...
      <div class="col-side">${r}${c}${_}${te(s)}</div>
    </div>`}function Vo(t,e,{me:n}){t.addEventListener("click",a=>{if(a.target.closest("[data-edit-contact]"))return Sn({contact:T,onDone:e});if(a.target.closest("[data-new-opp-for]"))return vn({me:n,contact:T,onDone:e})}),ee(t,{contact_id:T.id},n,e)}function Qo(){return T?[T.companies?.name,T.job_title].filter(Boolean).map(o).join(" \xB7 "):""}var Wo,T,Ca=O(()=>{H();W();I();K();z();yt();Ze();Wo=()=>T?.full_name||"Contact",T=null});var La={};Z(La,{editOpportunity:()=>zo});async function zo({opp:t,me:e,onDone:n}){let a=await d.profiles();F({title:"Edit opportunity",sub:t.ref,width:620,submitLabel:"Save",body:`
      ...
      <div class="field-row">
        ...
        ${u("source","Source",N("source",De.map(s=>[s,At[s]]),t.source))}
      </div>
      ...
      <div class="field-row">
        ...
        ${u("priority","Priority",N("priority",ue.map(s=>[s,Go(s)]),t.priority))}
      </div>
      ...
      ${u("description","What do they want?",B("description",t.description||"",4),{wide:!0})}`,onSubmit:async s=>{if(!s.title)throw C("title","Give the job a name.");await d.updateOpportunity(t.id,{title:s.title,service:h(s.service),source:s.source,location:h(s.location),owner_id:h(s.owner_id),priority:s.priority,site_visit_required:!!s.site_visit_required,description:h(s.description)}),b("Saved."),R(n)}})}var Go,Aa=O(()=>{H();W();I();ut();Go=t=>t.charAt(0).toUpperCase()+t.slice(1)});var Na={};Z(Na,{mount:()=>Jo,render:()=>Zo,sub:()=>Yo,title:()=>Ko});async function Zo(t,{me:e}){if(p=await d.opportunity(t),!p)return x("That opportunity no longer exists.","It may have been deleted.",{tone:"quiet"});let[n,a,s,i,r,c]=await Promise.all([d.activityFor(t),d.quotesFor(t),d.visitsFor(t),d.tasksFor(t),d.filesFor("opportunity_id",t),d.projectForOpportunity(t)]);ne={activity:n,quotes:a,visits:s,tasks:i,files:r,project:c,me:e};let _=ct(p),g=tt(p),k=a.find(y=>y.status==="draft"),xt=a.some(y=>y.sent_on),rt=_t(p),U=_.level==="overdue"||_.level==="unbooked",Q={full_name:p.contact_name,phone:p.contact_phone,whatsapp:p.contact_whatsapp,email:p.contact_email},mt=`
  <section class="opp-head${U?" opp-head-alarm":""}">
    <div class="opp-head-top">
      <div class="opp-stage-set">
        ...
        <select class="sel sel-inline" id="opp-stage" data-stage>
          ${ht.map(y=>`<option value="${o(y.id)}"${y.id===p.stage?" selected":""}>${o(y.name)}</option>`).join("")}
        </select>
        ${Pt(p.priority)}
        ${Mt(p.source)}
      </div>
    ...
    <div class="opp-next${U?" is-alarm":""}">
      ...
      <div class="opp-next-body">
        ...
        ${p.next_action||p.next_action_due?`
          ...
          <p class="opp-next-meta">
            ...
            <strong>${o(_.level==="held"?"on hold":lt(p)?Re(p.next_action_due):A(p.next_action_due))}</strong>
          </p>
          ${p.stage==="on_hold"&&p.hold_reason?`<p class="opp-next-meta">On hold: ${o(p.hold_reason)}</p>`:""}
          ${p.customer_replied_at?`<p class="opp-next-meta">Customer replied ${o(A(p.customer_replied_at))} \xB7 ${o(ot(p.customer_replied_at))}</p>`:""}`:_t(p)?`
      ...
      ${_t(p)?`<button type="button" class="btn btn-sm" data-followup>
    ...
    <span><strong>Demonstration record.</strong> Not counted in any total or report.</span></p>`:"",Ut=$("The job",`
    ...
    <dl class="kv">
      ...
      <div><dt>Came in by</dt><dd>${Mt(p.source)}</dd></div>
      ${p.lost_reason?`<div class="kv-wide"><dt>Reason lost</dt><dd>${o(p.lost_reason)}</dd></div>`:""}
    </dl>`,{action:`<button type="button" class="btn-ghost btn-xs" data-edit-opp>${l.edit(13)}<span>Edit</span></button>`}),It=$("Customer",p.contact_name?`
    ...
    <div class="contact">
      ...
      <div class="contact-body">
        ...
        <div class="contact-lines">
          ${p.contact_phone?`<a class="lnk" href="${o(ft(p.contact_phone))}">${l.phone(13)}${o(p.contact_phone)}</a>`:""}
          ${p.contact_email?`<a class="lnk" href="${o(Et(p.contact_email))}">${l.mail(13)}${o(p.contact_email)}</a>`:""}
        </div>
      </div>
    </div>
    <div class="contact-acts">${$t(Q,{text:`Good day ${p.contact_name.split(" ")[0]}, Kingson Engineering here regarding ${p.title}.`})}</div>
    ...
    <ul class="mini">
      ${xe.map(y=>`<li>
       ...
       <button type="button" class="btn btn-sm" data-convert>${l.briefcase(14)}<span>Open a project</span></button>`),Bt=$("Activity",`
    <div class="log-add">
    ...
    ${mt}
    <div class="grid grid-opp">
      <div class="col-wide">${Ut}${Bt}</div>
      <div class="col-side">${It}${tn}${ve}${Ye}${Xe}${te(ne.files)}</div>
    </div>`}function Jo(t,e,{me:n}){let a=()=>e();t.addEventListener("change",async s=>{let i=s.target.closest("[data-stage]");if(!i)return;let r=i.value;if(r!==p.stage&&!Ve(r,{opp:p,onDone:a,onCancel:()=>{i.value=p.stage}}))try{await d.setStage(p.id,r),b(`Moved to ${nt[r].name}.`),await a()}catch(c){b(c.message||"That could not be saved.","bad"),i.value=p.stage}}),t.addEventListener("click",async s=>{let i=k=>s.target.closest(k);if(i("[data-followup]"))return kn({opp:p,me:n,onDone:a});if(i("[data-log]"))return xn({opportunityId:p.id,contactId:p.contact_id,me:n,onDone:a});if(i("[data-record-quote]"))return fa({opp:p,quotes:ne.quotes,onDone:a});if(i("[data-log-followup]"))return He({opp:p,onDone:a});if(i("[data-replied]"))return $a({opp:p,onDone:a});if(i("[data-won]"))return yn({opp:p,onDone:a});if(i("[data-lost]"))return gn({opp:p,onDone:a});if(i("[data-hold]"))return bn({opp:p,onDone:a});let r=i("[data-mark-sent]");if(r)return Fe({opp:p,quote:ne.quotes.find(k=>k.id===r.dataset.markSent),onDone:a});if(i("[data-new-visit]"))return Yt({opp:p,me:n,onDone:a});if(i("[data-new-task]"))return ye({opp:p,me:n,onDone:a});if(i("[data-convert]"))return Tn({opp:p});let c=i("[data-quote]");if(c)return We({opp:p,quote:ne.quotes.find(k=>k.id===c.dataset.quote),onDone:a});let _=i("[data-visit]");if(_)return Yt({opp:p,visit:ne.visits.find(k=>k.id===_.dataset.visit),me:n,onDone:a});let g=i("[data-done]");if(g){try{await d.completeTask(g.dataset.done),b("Task completed."),await a()}catch(k){b(k.message,"bad")}return}if(i("[data-edit-opp]")){let{editOpportunity:k}=await Promise.resolve().then(()=>(Aa(),La));return k({opp:p,me:n,onDone:a})}}),ee(t,{opportunity_id:p.id},n,a)}function Yo(){return p?`${o(p.company_name||p.contact_name||"")} \xB7 ${o(p.service||nt[p.stage].name)}`:""}var p,ne,Ko,Oa=O(()=>{H();W();I();K();z();ut();yt();fe();Ze();p=null,ne={},Ko=()=>p?.title||"Opportunity"});var Pa={};Z(Pa,{mount:()=>es,render:()=>ts,sub:()=>ns,title:()=>Xo});async function ts(t,{me:e}){return ae=await d.quotes(),Ma()}function Ma(){let t=wt==="all"?ae:wt==="live"?ae.filter(a=>a.status==="sent"||a.status==="discussed"):ae.filter(a=>a.status===wt),e=`
    <div class="filters">
      <label class="sr-only" for="q-filter">Show</label>
      <select class="sel sel-inline" id="q-filter" data-f>
        <option value="live"${wt==="live"?" selected":""}>Awaiting a decision</option>
        <option value="all"${wt==="all"?" selected":""}>All quotations</option>
        ${Vn.map(a=>`<option value="${a}"${wt===a?" selected":""}>${o(Ce[a])}</option>`).join("")}
      </select>
      <span class="filters-n">${o(v(t.length,"quotation"))} \xB7 <span class="num">${o(ja(t))}</span></span>
    </div>`,n=t.length?pt(`
    <table class="tbl tbl-rows">
      <thead><tr>
    ...
    </table>`):x(wt==="live"?"No quotations are out.":"Nothing matches that filter.",wt==="live"?"Everything issued has been decided.":"",{tone:"ok"});return e+$("",n,{tight:!0})}function es(t,e,{me:n}){t.addEventListener("change",a=>{a.target.closest("[data-f]")&&(wt=a.target.value,document.getElementById("view").innerHTML=Ma())}),t.addEventListener("click",async a=>{let s=a.target.closest("[data-edit], [data-send]");if(!s)return;let i=ae.find(c=>c.id===(s.dataset.edit||s.dataset.send));if(!i)return;let r=await d.opportunity(i.opportunity_id);s.dataset.send?Fe({opp:r,quote:i,onDone:e}):We({opp:r,quote:i,onDone:e})})}function ns(){let t=ae.filter(e=>e.status==="sent"||e.status==="discussed");return`${o(v(t.length,"quotation"))} awaiting a decision \xB7 <span class="num">${o(ja(t))}</span>`}var ja,Xo,ae,wt,Ra=O(()=>{H();W();I();K();z();fe();ja=t=>{let e={};for(let n of t)e[n.currency]=(e[n.currency]||0)+Number(n.amount||0);return at(e,{empty:"\u2014"})},Xo="Quotations",ae=[],wt="live"});var Ua={};Z(Ua,{mount:()=>ss,render:()=>os,sub:()=>is,title:()=>as});async function os(t,{me:e}){oe=await d.visits();let n=oe.filter(i=>i.status==="scheduled"&&q(i.scheduled_at)>=0).sort((i,r)=>new Date(i.scheduled_at)-new Date(r.scheduled_at)),a=oe.filter(i=>i.status==="scheduled"&&q(i.scheduled_at)<0).sort((i,r)=>new Date(r.scheduled_at)-new Date(i.scheduled_at)),s=oe.filter(i=>i.status!=="scheduled").sort((i,r)=>new Date(r.scheduled_at)-new Date(i.scheduled_at)).slice(0,30);return`
    ...
    </table>`),{tight:!0,note:`${v(e.length,"project")} \xB7 ${L(dn(e,n=>n.value))}`}):$(t,x("Nothing here.","",{tone:"quiet"}),{tight:!0})}function cs(){let t=ge.filter(e=>["planning","in_progress","on_hold"].includes(e.status));return`${o(v(t.length,"active project"))} \xB7 <span class="num">${o(L(dn(t,e=>e.value)))}</span>`}var rs,ge,Wa=O(()=>{H();W();I();K();z();rs="Projects",ge=[]});var Ha={};Z(Ha,{mount:()=>us,render:()=>ps,sub:()=>ms,title:()=>ds});async function ps(t,{me:e}){if(w=await d.project(t),!w)return x("That project no longer exists.","",{tone:"quiet"});let[n,a]=await Promise.all([d.activityForProject(t),d.filesFor("project_id",t)]),i=`
    <section class="opp-head${w.target_date&&q(w.target_date)<0&&w.status!=="complete"?" opp-head-alarm":""}">
      <div class="opp-head-top">
        <div class="opp-stage-set">
          ${Qt(w.status)}
          ${w.opportunities?`<a class="lnk" href="#/opportunity/${o(w.opportunities.id)}">from ${o(w.opportunities.ref)}</a>`:""}
        </div>
        <dl class="opp-figs">
          <div><dt>Value</dt><dd class="num">${o(L(w.value,w.currency))}</dd></div>
          <div><dt>Start</dt><dd>${o(j(w.start_date))}</dd></div>
          <div><dt>Target</dt><dd>${o(j(w.target_date))}
            ${w.target_date?`<span class="dim">(${o(A(w.target_date))})</span>`:""}</dd></div>
          <div><dt>Responsible</dt><dd class="opp-owner">${E(w.profiles,24)}${o(w.profiles?.full_name||"Unassigned")}</dd></div>
        </dl>
      </div>
    </section>`,r=$("The job",`
    ${w.description?`<p class="scope">${o(w.description)}</p>`:'<p class="scope dim">No description.</p>'}
    ${w.notes?`<dl class="kv"><div class="kv-wide"><dt>Notes</dt><dd>${o(w.notes)}</dd></div></dl>`:""}`,{action:`<button type="button" class="btn-ghost btn-xs" data-edit-project>${l.edit(13)}<span>Edit</span></button>`}),c=$("Client",`
    <p class="co-name">${o(w.companies?.name||"\u2014")}</p>
    ${w.contacts?`
      <div class="contact">
        ${E({full_name:w.contacts.full_name},34)}
        <div class="contact-body">
          <p class="contact-name"><a class="lnk" href="#/contact/${o(w.contacts.id)}">${o(w.contacts.full_name)}</a></p>
          <div class="contact-lines">
            ${w.contacts.phone?`<a class="lnk" href="${o(ft(w.contacts.phone))}">${l.phone(13)}${o(w.contacts.phone)}</a>`:""}
            ${w.contacts.email?`<a class="lnk" href="${o(Et(w.contacts.email))}">${l.mail(13)}${o(w.contacts.email)}</a>`:""}
          </div>
        </div>
      </div>
      <div class="contact-acts">${$t(w.contacts,{text:`Good day, Kingson Engineering here regarding ${w.name}.`})}</div>`:'<p class="dim">No contact linked.</p>'}`);return`
    ...
    </div>`}function us(t,e,{me:n}){t.addEventListener("click",a=>{if(a.target.closest("[data-edit-project]"))return qn({project:w,me:n,onDone:e})}),ee(t,{project_id:w.id},n,e)}function ms(){return w?[w.companies?.name,Ft[w.status]].filter(Boolean).map(o).join(" \xB7 "):""}var ds,w,Va=O(()=>{H();W();I();K();z();yt();Ze();ds=()=>w?.name||"Project",w=null});var Ga={};Z(Ga,{mount:()=>bs,render:()=>ys,sub:()=>_s,title:()=>$s});async function ys(t,{me:e}){vt=await d.settings().catch(()=>null);let n=gs(e);if(e?.role!=="admin")return`${Qa()}${n}`;[Cn,Je]=await Promise.all([d.profiles(),d.enquiries(60)]);let a=$("People",pt(`
    <table class="tbl tbl-rows">
    ...
    </table>`),{tight:!0,note:"Staff run the pipeline. Administrators can also delete records and change roles."}),s=$("Adding somebody",`
    ...
    </table>`):x("No website enquiries yet.","Everything submitted on kingson-engineering.vercel.app lands here and in the pipeline.",{tone:"quiet"}),{tight:!0,note:`${v(Je.length,"submission")} \xB7 the last sixty`});return`${Qa()}${n}${a}${s}${i}`}function gs(t){if(!vt)return $("Working rules",x("The settings could not be read.","",{tone:"quiet"}));let e=t?.role==="admin",n=(vt.working_weekdays||[]).map(a=>hs[a]).join(", ");return $("Working rules",`
    <div class="settings-grid">
      ...
      <div class="field">
        ...
        <p class="field-hint">${o(fs[vt.email_mode]||"")}</p>
      </div>
  ...
  <label class="check"><input type="checkbox" data-demo ${Ot()?"checked":""}>
    <span>Show demonstration records in this browser</span></label>`)});ln();W();var et=null,eo=new Set,je=()=>et;var Zn=()=>!!(sn()?.access_token&&et);var pn=()=>eo.forEach(t=>t(et));function no(t){try{let e=t.split(".")[1],n=atob(e.replace(/-/g,"+").replace(/_/g,"/"));return JSON.parse(n).sub||null}catch{return null}}async function Jn(){let t=sn(),e=t?.access_token?no(t.access_token):null;if(!e)return et=null,null;let a=(await f.select("profiles",`select=*&id=eq.${e}`))[0]||null;if(!a)throw et=null,Lt(null),new Error("This account has no profile in the CRM. Ask an administrator to set one up.");if(!a.active)throw et=null,Lt(null),new Error("This account has been deactivated.");return et=a,et}async function Yn(){if(!Un())return et=null,null;try{await Jn()}catch{et=null}return pn(),et}async function Xn(t,e){return await Fn(t,e),await Jn(),pn(),Kn(f).catch(()=>{}),et}async function ta(){await Wn(),et=null,pn()}H();W();Me();I();z();var co=[{key:"dashboard",href:"#/",label:"Dashboard",ic:"dashboard"},{key:"pipeline",href:"#/pipeline",label:"Pipeline",ic:"pipeline"},{key:"followups",href:"#/followups",label:"Follow-ups",ic:"bell",badge:!0},{key:"tasks",href:"#/tasks",label:"Tasks",ic:"task"},{key:"contacts",href:"#/contacts",label:"Contacts",ic:"users"},{key:"quotes",href:"#/quotes",label:"Quotations",ic:"doc"},{key:"visits",href:"#/visits",label:"Site visits",ic:"pin"},{key:"projects",href:"#/projects",label:"Projects",ic:"briefcase"},{key:"settings",href:"#/settings",label:"Settings",ic:"shield"}];function hn(t,e,{overdue:n=0}={}){return`
  <div class="rail-top">
    <a class="mark" href="#/">
  ...
  <nav class="rail-nav" aria-label="Sections">${co.filter(s=>!s.admin||e?.role==="admin").map(s=>`
  ...
  </div>`;K();ut();I();var re=document.getElementById("app"),Ln=document.getElementById("rail"),ie=document.getElementById("topbar"),gt=document.getElementById("view"),jn=document.getElementById("scrim"),se=document.getElementById("gate");if(Ot()){let t=document.createElement("p");t.className="demo-banner",t.setAttribute("role","note"),t.innerHTML="<strong>Demonstration records are showing.</strong>&nbsp;Totals include sample data. Switch off in Settings.",ie.before(t)}var An={dashboard:()=>Promise.resolve().then(()=>(ma(),ua)),pipeline:()=>Promise.resolve().then(()=>(ga(),ya)),followups:()=>Promise.resolve().then(()=>(_a(),ba)),tasks:()=>Promise.resolve().then(()=>(ka(),xa)),contacts:()=>Promise.resolve().then(()=>(qa(),Ta)),contact:()=>Promise.resolve().then(()=>(Ca(),Da)),opportunity:()=>Promise.resolve().then(()=>(Oa(),Na)),quotes:()=>Promise.resolve().then(()=>(Ra(),Pa)),visits:()=>Promise.resolve().then(()=>(Ia(),Ua)),projects:()=>Promise.resolve().then(()=>(Wa(),Fa)),project:()=>Promise.resolve().then(()=>(Va(),Ha)),settings:()=>Promise.resolve().then(()=>(za(),Ga))},ws={opportunity:"pipeline",contact:"contacts",project:"projects"},it=Ka(),Nn=0;function Ka(){let t=(location.hash||"#/").replace(/^#\/?/,""),[e,n]=t.split("/");return e?An[e]?{key:e,arg:n||null}:{key:"dashboard",arg:null}:{key:"dashboard",arg:null}}async function Mn(){try{Nn=(await d.openOpportunities()).filter(lt).length}catch{}}var be=0;function vs(){let t=gt.cloneNode(!1);return delete t.dataset.view,gt.replaceWith(t),gt=t,t}async function we(){if(!Zn())return _e();let t=++be,e=je(),n=ws[it.key]||it.key;Ln.innerHTML=hn(n,e,{overdue:Nn}),Pn();let a;try{a=await(An[it.key]||An.dashboard)()}catch{ie.innerHTML=Ue("Kingson"),gt.innerHTML=fn("That screen could not be loaded. Check the connection and try again.");return}if(t===be){ie.innerHTML=Ue(typeof a.title=="function"?a.title(it.arg):a.title,""),vs(),gt.innerHTML=la(4),gt.dataset.view=it.key;try{let s=await a.render(it.arg,{me:e,rerender:On});if(t!==be)return;gt.innerHTML=s,ie.innerHTML=Ue(typeof a.title=="function"?a.title(it.arg):a.title,typeof a.sub=="function"?await a.sub(it.arg):a.sub||"",typeof a.actions=="function"?a.actions(it.arg,e):""),a.mount?.(gt,On,{me:e,arg:it.arg})}catch(s){if(t!==be)return;console.error("[kingson] view failed",it.key,s),gt.innerHTML=fn(s?.message||"That screen could not be loaded.")}Mn().then(()=>{t===be&&(Ln.innerHTML=hn(n,je(),{overdue:Nn}))})}}async function On(){let t=window.scrollY;await we(),window.scrollTo(0,t)}function _e(t=""){re.hidden=!0,se.hidden=!1,se.innerHTML=ra(t);let e=se.querySelector("#signin-form"),n=e.querySelector("[data-signin]"),a=e.querySelector(".signin-err");e.querySelector("#si-email").focus(),e.addEventListener("submit",async s=>{s.preventDefault();let i=e.querySelector("#si-email").value.trim(),r=e.querySelector("#si-password").value;if(a.hidden=!0,!i||!r){a.textContent="Enter your email address and password.",a.hidden=!1;return}n.disabled=!0,n.textContent="Signing in\u2026";try{await Xn(i,r),se.hidden=!0,se.innerHTML="",re.hidden=!1,await Mn(),await we()}catch(c){a.textContent=c?.status===400?"That email address and password do not match an account.":c?.message||"Sign-in failed.",a.hidden=!1,n.disabled=!1,n.textContent="Sign in",e.querySelector("#si-password").select()}})}var xs=()=>{re.classList.add("rail-open"),jn.hidden=!1,Ln.querySelector(".rail-link")?.focus(),ie.querySelector("[data-rail-open]")?.setAttribute("aria-expanded","true")},Pn=()=>{re.classList.remove("rail-open"),jn.hidden=!0,ie.querySelector("[data-rail-open]")?.setAttribute("aria-expanded","false")};document.addEventListener("click",async t=>{if(t.target.closest("[data-rail-open]"))return xs();if(t.target===jn||t.target.closest(".rail-link"))return Pn();if(t.target.closest("[data-signout]")){await ta(),location.hash="#/",_e();return}if(t.target.closest("[data-retry]"))return we();let e=je();if(t.target.closest("[data-new-opp]")){let{newOpportunity:n}=await Promise.resolve().then(()=>(yt(),ze));return n({me:e})}if(t.target.closest("[data-new-contact]")){let{contactDialog:n}=await Promise.resolve().then(()=>(yt(),ze));return n({onDone:a=>{location.hash=`#/contact/${a.id}`}})}if(t.target.closest("[data-new-task-global]")){let{taskDialog:n}=await Promise.resolve().then(()=>(yt(),ze));return n({me:e,onDone:On})}});document.addEventListener("keydown",t=>{t.key==="Escape"&&re.classList.contains("rail-open")&&Pn()});addEventListener("hashchange",()=>{it=Ka(),we().then(()=>{gt.focus({preventScroll:!0}),scrollTo(0,0)})});addEventListener("storage",t=>{t.key==="kingson-crm/session/v1"&&!t.newValue&&_e("Signed out in another tab.")});(async function(){if(document.getElementById("boot")?.remove(),!await Yn())return _e();se.hidden=!0,re.hidden=!1,await Mn(),await we()})().catch(t=>{console.error("[kingson] boot failed",t),_e("Something went wrong starting the application. Reload the page.")});export{o as esc,On as softRender,b as toast};
