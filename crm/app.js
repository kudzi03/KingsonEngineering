var En=Object.defineProperty;var D=(t,e,a)=>()=>{if(a)throw a[0];try{return t&&(e=t(t=0)),e}catch(o){throw a=[o],o}};var z=(t,e)=>{for(var a in e)En(t,a,{get:e[a],enumerable:!0})};var te,$e,ee,vt,ae=D(()=>{te="https://fgzwcxwmaohowryzdgui.supabase.co",$e="sb_publishable_QYbHrEJ06GpGDMlIqf5tzw_ijJpdtTV",ee="kingson-files",vt="Africa/Harare"});function ua(){try{let t=localStorage.getItem(Ie);F=t?JSON.parse(t):null}catch{F=null}return F}function Fe(){return F}function Lt(t){F=t;try{t?localStorage.setItem(Ie,JSON.stringify(t)):localStorage.removeItem(Ie)}catch{}return t}function ne(t,e){let a=e?.code||"",o=e?.message||e?.error_description||e?.msg||"";return a==="23505"?/contacts_email_key/.test(o)?"A contact with that email address already exists.":/companies_name_key/.test(o)?"A company with that name already exists.":"That record already exists.":a==="23514"?/lost_has_reason/.test(o)?"A lost opportunity needs a reason.":/quotes_sent_has_date/.test(o)?"A quotation marked sent needs the date it went out.":/contacts_reachable/.test(o)?"A contact needs a phone number, a WhatsApp number or an email address.":/amount_sane|value_sane/.test(o)?"That amount cannot be negative.":"That value is not allowed here.":a==="23503"?"That record is still attached to something else.":t===401?"Your session has expired. Sign in again.":t===403||a==="42501"?"You do not have permission to do that.":t===404?"That record no longer exists.":t===0?"No connection. Check the network and try again.":o||`Request failed (${t}).`}async function We(t,{method:e="POST",body:a,token:o}={}){let s;try{s=await fetch(`${te}/auth/v1${t}`,{method:e,headers:{apikey:$e,"Content-Type":"application/json",...o?{Authorization:`Bearer ${o}`}:{}},body:a?JSON.stringify(a):void 0})}catch{throw new bt(ne(0),{status:0})}let i=await s.text(),r=i?JSON.parse(i):null;if(!s.ok)throw new bt(ne(s.status,r),{status:s.status,code:r?.code||""});return r}async function fa(t,e){let a=await We("/token?grant_type=password",{body:{email:t.trim(),password:e}});return Lt(ma(a))}async function $a(){let t=F;if(Lt(null),t?.access_token)try{await We("/logout",{token:t.access_token})}catch{}}async function Be(){if(!F?.refresh_token)throw new bt("Your session has expired. Sign in again.",{status:401});return ye||(ye=We("/token?grant_type=refresh_token",{body:{refresh_token:F.refresh_token}}).then(t=>Lt(ma(t))).catch(t=>{throw Lt(null),t}).finally(()=>{ye=null})),ye}async function gt(t,{method:e="GET",body:a,headers:o={},retry:s=!0}={}){if(F&&ha())try{await Be()}catch{}let i;try{i=await fetch(`${te}${t}`,{method:e,headers:{apikey:$e,"Content-Type":"application/json",...F?.access_token?{Authorization:`Bearer ${F.access_token}`}:{},...o},body:a===void 0?void 0:JSON.stringify(a)})}catch{throw new bt(ne(0),{status:0})}if(i.status===401&&s&&F?.refresh_token)try{return await Be(),gt(t,{method:e,body:a,headers:o,retry:!1})}catch{}let r=await i.text(),l=null;try{l=r?JSON.parse(r):null}catch{l=r}if(!i.ok)throw new bt(ne(i.status,l),{status:i.status,code:l?.code||"",details:l?.details||"",hint:l?.hint||""});return l}var Ie,F,ye,ma,ha,bt,y,ge,L,Q,He=D(()=>{ae();Ie="kingson-crm/session/v1",F=null,ye=null;ma=t=>({access_token:t.access_token,refresh_token:t.refresh_token,expires_at:Date.now()+((t.expires_in||3600)-60)*1e3,user:t.user||null}),ha=()=>!F||!F.expires_at||Date.now()>=F.expires_at,bt=class extends Error{constructor(e,{status:a=0,code:o="",details:s="",hint:i=""}={}){super(e),this.name="ApiError",this.status=a,this.code=o,this.details=s,this.hint=i}};y={select:(t,e="")=>gt(`/rest/v1/${t}${e?"?"+e:""}`),count:async(t,e="")=>{let a=await gt(`/rest/v1/${t}?select=id&limit=1${e?"&"+e:""}`,{headers:{Prefer:"count=exact"}});return Array.isArray(a)?a.length:0},insert:(t,e,a="")=>gt(`/rest/v1/${t}${a?"?"+a:""}`,{method:"POST",body:e,headers:{Prefer:"return=representation"}}),update:(t,e,a)=>gt(`/rest/v1/${t}?${e}`,{method:"PATCH",body:a,headers:{Prefer:"return=representation"}}),remove:(t,e)=>gt(`/rest/v1/${t}?${e}`,{method:"DELETE",headers:{Prefer:"return=representation"}}),rpc:(t,e={})=>gt(`/rest/v1/rpc/${t}`,{method:"POST",body:e})},ge={async upload(t,e,a){if(F&&ha())try{await Be()}catch{}let o;try{o=await fetch(`${te}/storage/v1/object/${t}/${encodeURI(e)}`,{method:"POST",headers:{apikey:$e,Authorization:`Bearer ${F?.access_token||""}`,"x-upsert":"false",...a.type?{"Content-Type":a.type}:{}},body:a})}catch{throw new bt(ne(0),{status:0})}if(!o.ok){let s=null;try{s=await o.json()}catch{}throw new bt(o.status===413?"That file is larger than the 25 MB limit.":s?.message||`Upload failed (${o.status}).`,{status:o.status})}return e},async signedUrl(t,e,a=120){let o=await gt(`/storage/v1/object/sign/${t}/${encodeURI(e)}`,{method:"POST",body:{expiresIn:a}});return`${te}/storage/v1${o.signedURL||o.signedUrl}`},async remove(t,e){return gt(`/storage/v1/object/${t}`,{method:"DELETE",body:{prefixes:e}})}},L=(t,e)=>`${t}=eq.${encodeURIComponent(e)}`,Q=(t,e="asc",a=!0)=>`order=${t}.${e}${a?".nullslast":""}`});function ht(){return new Intl.DateTimeFormat("en-CA",{timeZone:vt}).format(new Date)}function q(t){if(!t)return null;let e=Date.parse(ht()+"T00:00:00Z"),a=Date.parse(String(t).slice(0,10)+"T00:00:00Z");return Number.isNaN(a)?null:Math.round((a-e)/864e5)}function be(t,e){let a=new Date(Date.parse(String(t).slice(0,10)+"T00:00:00Z"));return a.setUTCDate(a.getUTCDate()+e),a.toISOString().slice(0,10)}function xe(t=ht(),e=1){let a=be(t,e);return new Date(a+"T00:00:00Z").getUTCDay()===0&&(a=be(a,1)),a}function ct(t){return!xt(t)||!t.next_action_due?!1:q(t.next_action_due)<0}function ke(t){return!xt(t)||!t.next_action_due?!1:q(t.next_action_due)===0}function dt(t){if(!xt(t))return{level:"closed",label:st[t.stage]?.name||"\u2014",sort:0};if(Ut(t))return{level:"unbooked",label:"No next action",sort:900};let e=q(t.next_action_due);if(e<0){let a=Math.abs(e);return{level:"overdue",label:a===1?"1 day overdue":`${a} days overdue`,sort:1e3+a}}return e===0?{level:"today",label:"Due today",sort:800}:e<=7?{level:"soon",label:e===1?"Due tomorrow":`Due in ${e} days`,sort:700-e}:{level:"clear",label:`Due in ${e} days`,sort:100-Math.min(e,99)}}function Se(t){return!xt(t)||!Number(t.live_quotes||0)?!1:!t.next_action_due||q(t.next_action_due)<0}async function _a(t){let e;try{e=await t.rpc("enum_values",{enum_name:"opp_stage"})}catch{return{ok:!0,skipped:!0}}let a=new Set((e||[]).map(r=>typeof r=="string"?r:r.value)),o=new Set(mt.map(r=>r.id)),s=[...a].filter(r=>!o.has(r)),i=[...o].filter(r=>!a.has(r));return(s.length||i.length)&&console.error("[kingson] pipeline stages disagree with the database",{missingFromApp:s,notInDatabase:i}),{ok:!s.length&&!i.length,missing:s,extra:i}}var mt,st,ya,se,_e,Ct,we,Nt,ga,Pt,ve,ba,xt,Ut,N,W=D(()=>{ae();mt=[{id:"new",name:"New enquiry",short:"New",open:!0,group:"intake"},{id:"contacted",name:"Contacted",short:"Contacted",open:!0,group:"intake"},{id:"requirements",name:"Requirements / site visit",short:"Requirements",open:!0,group:"survey"},{id:"quoting",name:"Quote / BOQ preparing",short:"Quoting",open:!0,group:"quote"},{id:"quote_sent",name:"Quote sent",short:"Quote sent",open:!0,group:"quote"},{id:"followup",name:"Follow-up due",short:"Follow-up",open:!0,group:"chase"},{id:"won",name:"Won",short:"Won",open:!1,group:"won"},{id:"lost",name:"Lost",short:"Lost",open:!1,group:"lost"}],st=Object.fromEntries(mt.map(t=>[t.id,t])),ya=mt.filter(t=>t.open).map(t=>t.id),se=["low","normal","high","urgent"],_e=["website","whatsapp","phone","email","referral","walk_in","other"],Ct={website:"Website",whatsapp:"WhatsApp",phone:"Phone",email:"Email",referral:"Referral",walk_in:"Walk-in",other:"Other"},we=["draft","sent","discussed","accepted","rejected","expired"],Nt={draft:"Draft",sent:"Sent",discussed:"Discussed",accepted:"Accepted",rejected:"Rejected",expired:"Expired"},ga=["planning","in_progress","on_hold","complete","cancelled"],Pt={planning:"Planning",in_progress:"In progress",on_hold:"On hold",complete:"Complete",cancelled:"Cancelled"},ve={enquiry:"Enquiry",note:"Note",call:"Call",whatsapp:"WhatsApp",email:"Email",meeting:"Meeting",site_visit:"Site visit",quote:"Quotation",stage_change:"Stage change",task:"Task",file:"File",won:"Won",lost:"Lost",system:"System"},ba=["call","whatsapp","email","meeting","note"];xt=t=>!!(t&&st[t.stage]?.open);Ut=t=>xt(t)&&!t.next_action_due;N=(t,e)=>t.reduce((a,o)=>a+(Number(e(o))||0),0)});var Qe,Ea,An,d,H=D(()=>{He();ae();W();Qe="*",Ea=Q("next_action_due","asc"),An=`stage=in.(${ya.join(",")})`,d={profiles:()=>y.select("profiles",`select=*&${Q("full_name")}`),me:t=>y.select("profiles",`select=*&${L("id",t)}`).then(e=>e[0]||null),opportunities:(t="")=>y.select("v_opportunity_state",`select=${Qe}&${Ea}${t?"&"+t:""}`),openOpportunities:()=>y.select("v_opportunity_state",`select=${Qe}&${An}&${Ea}`),opportunity:t=>y.select("v_opportunity_state",`select=${Qe}&${L("id",t)}`).then(e=>e[0]||null),createOpportunity:t=>y.insert("opportunities",t).then(e=>e[0]),updateOpportunity:(t,e)=>y.update("opportunities",L("id",t),e).then(a=>a[0]),async setStage(t,e,{lostReason:a}={}){let o={stage:e};return e==="lost"&&(o.lost_reason=(a||"").trim()||"No reason recorded"),d.updateOpportunity(t,o)},contacts:(t="")=>{let e=`select=*,companies(id,name)&${Q("full_name")}`;if(t){let a=encodeURIComponent(`%${t}%`);e+=`&or=(full_name.ilike.${a},email.ilike.${a},phone.ilike.${a},whatsapp.ilike.${a})`}return y.select("contacts",e)},contact:t=>y.select("contacts",`select=*,companies(id,name,kind,town)&${L("id",t)}`).then(e=>e[0]||null),createContact:t=>y.insert("contacts",t).then(e=>e[0]),updateContact:(t,e)=>y.update("contacts",L("id",t),e).then(a=>a[0]),companies:()=>y.select("companies",`select=*&${Q("name")}`),company:t=>y.select("companies",`select=*&${L("id",t)}`).then(e=>e[0]||null),createCompany:t=>y.insert("companies",t).then(e=>e[0]),updateCompany:(t,e)=>y.update("companies",L("id",t),e).then(a=>a[0]),async findOrCreateCompany(t){let e=(t||"").trim();if(!e)return null;let a=await y.select("companies",`select=id,name&name=ilike.${encodeURIComponent(e)}&limit=1`);return a[0]?a[0]:d.createCompany({name:e})},activityFor:t=>y.select("activities",`select=*,profiles(full_name,initials)&${L("opportunity_id",t)}&${Q("occurred_at","desc")}`),activityForContact:t=>y.select("activities",`select=*,profiles(full_name,initials),opportunities(id,ref,title)&${L("contact_id",t)}&${Q("occurred_at","desc")}`),activityForProject:t=>y.select("activities",`select=*,profiles(full_name,initials)&${L("project_id",t)}&${Q("occurred_at","desc")}`),recentActivity:(t=12)=>y.select("activities",`select=*,profiles(full_name,initials),opportunities(id,ref,title)&${Q("occurred_at","desc")}&limit=${t}`),logActivity:t=>y.insert("activities",t).then(e=>e[0]),tasks:(t="")=>y.select("tasks",`select=*,profiles!tasks_owner_id_fkey(full_name,initials),opportunities(id,ref,title,stage),contacts(id,full_name,phone,whatsapp,email)&${Q("due_date")}${t?"&"+t:""}`),openTasks:()=>d.tasks("status=eq.open"),tasksFor:t=>d.tasks(L("opportunity_id",t)),createTask:t=>y.insert("tasks",t).then(e=>e[0]),updateTask:(t,e)=>y.update("tasks",L("id",t),e).then(a=>a[0]),completeTask:t=>d.updateTask(t,{status:"done"}),visits:(t="")=>y.select("site_visits",`select=*,profiles(full_name,initials),opportunities(id,ref,title,company_id,companies(name))&${Q("scheduled_at")}${t?"&"+t:""}`),upcomingVisits:()=>d.visits(`status=eq.scheduled&scheduled_at=gte.${new Date(Date.now()-864e5).toISOString()}`),visitsFor:t=>d.visits(L("opportunity_id",t)),createVisit:t=>y.insert("site_visits",t).then(e=>e[0]),updateVisit:(t,e)=>y.update("site_visits",L("id",t),e).then(a=>a[0]),quotes:(t="")=>y.select("quotes",`select=*,opportunities(id,ref,title,stage,next_action_due,company_id,companies(name))&${Q("prepared_on","desc")}${t?"&"+t:""}`),liveQuotes:()=>d.quotes("status=in.(sent,discussed)"),quotesFor:t=>d.quotes(L("opportunity_id",t)),createQuote:t=>y.insert("quotes",t).then(e=>e[0]),updateQuote:(t,e)=>y.update("quotes",L("id",t),e).then(a=>a[0]),projects:(t="")=>y.select("projects",`select=*,companies(id,name),contacts(id,full_name,phone,email),profiles(full_name,initials),opportunities(id,ref)&${Q("created_at","desc")}${t?"&"+t:""}`),project:t=>y.select("projects",`select=*,companies(id,name),contacts(id,full_name,phone,email,whatsapp),profiles(full_name,initials),opportunities(id,ref,title)&${L("id",t)}`).then(e=>e[0]||null),updateProject:(t,e)=>y.update("projects",L("id",t),e).then(a=>a[0]),convertToProject:(t,{name:e,startDate:a,targetDate:o}={})=>y.rpc("convert_to_project",{p_opportunity_id:t,p_name:e||null,p_start_date:a||null,p_target_date:o||null}),projectForOpportunity:t=>y.select("projects",`select=id,name,status&${L("opportunity_id",t)}`).then(e=>e[0]||null),enquiries:(t=50)=>y.select("enquiries",`select=*&${Q("created_at","desc")}&limit=${t}`),filesFor:(t,e)=>y.select("files",`select=*,profiles(full_name,initials)&${L(t,e)}&${Q("created_at","desc")}`),async uploadFile(t,e,a){let o=t.name.replace(/[^\w.\-]+/g,"_").slice(-80),s=`${Object.keys(e)[0].replace("_id","")}/${Object.values(e)[0]}/${Date.now()}-${o}`;await ge.upload(ee,s,t);try{return await y.insert("files",{bucket:ee,path:s,name:t.name,mime:t.type||null,size_bytes:t.size,uploaded_by:a||null,...e}).then(i=>i[0])}catch(i){try{await ge.remove(ee,[s])}catch{}throw i}},downloadUrl:t=>ge.signedUrl(ee,t,120),async dashboard(){let[t,e,a,o,s,i]=await Promise.all([d.openOpportunities(),d.liveQuotes(),d.openTasks(),d.upcomingVisits(),d.recentActivity(10),y.select("v_opportunity_state",`select=id,stage,estimated_value,decided_at&stage=in.(won,lost)&${Q("decided_at","desc")}&limit=200`)]);return{open:t,liveQuotes:e,tasks:a,visits:o,recent:s,decided:i}}}});function Te(t){let e=Number(t);if(!Number.isFinite(e)||e===0)return t===0?"$0":"\u2014";let a=Math.abs(e);return a>=1e6?"$"+(e/1e6).toFixed(a%1e6?1:0)+"m":a>=1e3?"$"+(e/1e3).toFixed(a%1e3&&a<1e4?1:0)+"k":"$"+Math.round(e)}function qe(t){if(!t)return"";let e=Object.fromEntries(new Intl.DateTimeFormat("en-CA",{timeZone:vt,year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hour12:!1}).formatToParts(new Date(t)).map(a=>[a.type,a.value]));return`${e.year}-${e.month}-${e.day}T${e.hour}:${e.minute}`}function ze(t){return t?new Date(t+":00+02:00").toISOString():null}function A(t){if(!t)return"\u2014";let e=q(ot(t));return e===null?"\u2014":e===0?"today":e===1?"tomorrow":e===-1?"yesterday":e>0?`in ${e} days`:`${-e} days ago`}function Ae(t){let e=q(ot(t));if(e===null||e>=0)return"";let a=Math.abs(e);return a===1?"1 day overdue":`${a} days overdue`}function Aa(t,e=""){let a=String(t||"").replace(/\D/g,"");return a.length<9?"":`https://wa.me/${a}${e?"?text="+encodeURIComponent(e):""}`}var Ln,k,Cn,jn,Dn,Ta,C,Ve,kt,ot,qa,x,n,ft,St,P=D(()=>{ae();W();Ln=new Intl.NumberFormat("en-US",{style:"currency",currency:"USD",maximumFractionDigits:0}),k=(t,e="USD")=>{if(t==null||t==="")return"\u2014";let a=Number(t);return Number.isFinite(a)?e==="USD"?Ln.format(a):`${e} ${a.toLocaleString("en-US",{maximumFractionDigits:0})}`:"\u2014"};Cn=new Intl.DateTimeFormat("en-GB",{day:"numeric",month:"short",timeZone:vt}),jn=new Intl.DateTimeFormat("en-GB",{day:"numeric",month:"short",year:"numeric",timeZone:vt}),Dn=new Intl.DateTimeFormat("en-GB",{day:"numeric",month:"short",hour:"2-digit",minute:"2-digit",hour12:!1,timeZone:vt}),Ta=t=>typeof t=="string"&&t.length===10?new Date(t+"T12:00:00Z"):new Date(t),C=t=>t?Cn.format(Ta(t)):"\u2014",Ve=t=>t?jn.format(Ta(t)):"\u2014",kt=t=>t?Dn.format(new Date(t)):"\u2014",ot=t=>t?typeof t=="string"&&t.length===10?t:new Intl.DateTimeFormat("en-CA",{timeZone:vt}).format(new Date(t)):"";qa=t=>String(t||"").split(/[\s.]+/).filter(Boolean).map(e=>e[0]).slice(0,2).join("").toUpperCase()||"?",x=(t,e,a)=>`${t} ${t===1?e:a||e+"s"}`,n=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),ft=t=>"tel:"+String(t||"").replace(/[^\d+]/g,"");St=(t,e="",a="")=>{if(!t)return"";let o=[];return e&&o.push("subject="+encodeURIComponent(e)),a&&o.push("body="+encodeURIComponent(a)),`mailto:${t}${o.length?"?"+o.join("&"):""}`}});var S,c,io,ro,G=D(()=>{S=(t,e=16)=>`<svg width="${e}" height="${e}" viewBox="0 0 24 24" fill="none" stroke="currentColor"
    ...
    </li>`}var f,oe,w,Ca,Je,pt,Mn,Dt,Nn,Rt,It,Ot,T,Da,Oa,Bt,Ce,K=D(()=>{P();W();G();f=(t,e,{note:a="",action:o="",tight:s=!1,id:i=""}={})=>`
  ...
  </div>`,pt=t=>`<div class="tbl-wrap">${t}</div>`;Mn=t=>t==="won"?`<span class="pill pill-won">${c.check(13)}Won</span>`:t==="lost"?`<span class="pill pill-lost">${c.cross(13)}Lost</span>`:`<span class="pill pill-quiet">${n(st[t]?.name||t)}</span>`,Dt=t=>`<span class="src">${(c[Nn[t]]||c.globe)(13)}${n(Ct[t]||t)}</span>`,Nn={website:"globe",whatsapp:"whatsapp",phone:"phone",email:"mail",referral:"users",walk_in:"pin",other:"note"},Rt=t=>{let e=t==="accepted"?"won":t==="rejected"||t==="expired"?"lost":"quiet",a=t==="accepted"?c.check(13):t==="rejected"||t==="expired"?c.cross(13):c.doc(13);return`<span class="pill pill-${e}">${a}${n(Nt[t]||t)}</span>`},It=t=>`<span class="pill pill-${t==="complete"?"won":t==="cancelled"?"lost":t==="on_hold"?"today":"quiet"}">${n(Pt[t]||t)}</span>`,Ot=t=>t==="urgent"?`<span class="pill pill-overdue">${c.alert(13)}Urgent</span>`:t==="high"?'<span class="pill pill-today">High</span>':t==="low"?'<span class="pill pill-quiet">Low</span>':"",T=(t,e=26)=>t?`<span class="avatar" style="--s:${e}px" title="${n(t.full_name||"")}">${n(t.initials||qa(t.full_name))}</span>`:`<span class="avatar avatar-none" style="--s:${e}px" title="Unassigned">?</span>`;Da=t=>`
  <li class="feed-row">
  ...
  <select class="sel" id="${n(t)}" name="${n(t)}" ${o}>
  ...
  </select>`;g=t=>t===""||t===void 0?null:t,Tt=t=>t===""||t===null||t===void 0?null:Number(t);Ft=null;Wt=null;U=(t,e)=>Object.assign(new Error(e),{field:t})});var Ra={};z(Ra,{render:()=>In,sub:()=>Bn,title:()=>Rn});async function In(){let{open:t,liveQuotes:e,tasks:a,visits:o,recent:s,decided:i}=await d.dashboard(),r=t.filter(ct),l=t.filter(ke),$=t.filter(Ut),h=t.filter(m=>m.stage==="new"),R=t.filter(Se),Z=i.filter(m=>m.stage==="won"),tt=i.filter(m=>m.stage==="lost"),I=Z.length+tt.length?Math.round(Z.length/(Z.length+tt.length)*100):0,B=a.filter(m=>m.due_date&&q(m.due_date)<=0),nt=o.filter(m=>{let M=q(m.scheduled_at);return M!==null&&M>=0&&M<=7}),et=`
    <div class="stats">
    ...
    </div>`,At=[...r,...$,...l,...h].filter((m,M,wt)=>wt.findIndex(Sn=>Sn.id===m.id)===M).sort((m,M)=>dt(M).sort-dt(m).sort).slice(0,12),Mt=f("Needs attention",At.length?`<ul class="att-list">${At.map(m=>ja(m)).join("")}</ul>`:w("Nothing is overdue and nothing is unbooked.","Every open opportunity has a next action with a date on it."),{note:"Overdue, unbooked, due today or unanswered \u2014 in any stage",tight:!0}),Re=f("Today and the week ahead",`
    <div class="two-up">
      <div>
    ...
    </div>`,{note:`${x(nt.length,"visit")} \xB7 ${x(B.length,"task")}`}),b=mt.filter(m=>m.open).map(m=>{let M=t.filter(wt=>wt.stage===m.id);return{s:m,n:M.length,value:N(M,wt=>wt.estimated_value)}}),bn=Math.max(1,...b.map(m=>m.value)),_n=f("Pipeline by stage",`
    <ul class="funnel">
      ${b.map(m=>`
        <li class="funnel-row${m.n?"":" is-empty"}">
          <a class="funnel-label" href="#/pipeline">${n(m.s.name)}</a>
          <span class="funnel-track"><span class="funnel-bar" style="--w:${(m.value/bn*100).toFixed(1)}%"></span></span>
    ...
    </div>`,{note:"Every decided opportunity on record"}),vn=f("Quotations awaiting a decision",e.length?pt(`
    <table class="tbl">
      <thead><tr>
      ...
      <tbody>
        ${e.map(m=>{let M=m.opportunities,wt=M&&!M.next_action_due;return`<tr${wt?' class="tr-risk"':""}>
            ...
            <td>${wt?`<span class="pill pill-overdue">${c.alert(13)}No chase booked</span>`:`<span class="pill pill-quiet">${n(C(M?.next_action_due))}</span>`}</td>
          </tr>`}).join("")}
      </tbody>
    </table>`):w("No quotations are out."),{note:R.length?`${x(R.length,"quotation")} with no follow-up booked`:"All of them have a chase date"}),fe={};for(let m of t)fe[m.source]=(fe[m.source]||0)+1;let xn=f("Where enquiries arrive",Object.keys(fe).length?`
    <ul class="srcs">
      ${Object.entries(fe).sort((m,M)=>M[1]-m[1]).map(([m,M])=>`<li class="srcs-row">${Dt(m)}<span class="srcs-n num">${M}</span></li>`).join("")}
    </ul>
    <p class="funnel-key">Open opportunities only. The website writes straight into this pipeline.</p>`:w("No open enquiries yet.","",{tone:"quiet"}),{tight:!0}),kn=f("Recent activity",s.length?`<ul class="feed">${s.map(Da).join("")}</ul>`:w("Nothing logged yet.","",{tone:"quiet"}),{tight:!0});return`
    ${et}
    <div class="grid grid-main">
      <div class="col-wide">${Mt}${Re}${vn}</div>
      <div class="col-side">${_n}${wn}${xn}${kn}</div>
    </div>`}function Bn(){return`<span class="sub-quiet">${n(C(ht()))}</span>`}var Rn,Ia=D(()=>{H();W();P();K();G();Rn="Dashboard"});var Ba={};z(Ba,{actions:()=>zn,mount:()=>Gn,render:()=>Wn,sub:()=>Vn,title:()=>Fn});async function Wn(){Ht=await d.openOpportunities();let t=await d.opportunities("stage=in.(won,lost)&order=decided_at.desc&limit=40"),e=[...Ht,...t];return e.length?`
    ...
    ${mt.map(a=>{let o=e.filter(r=>r.stage===a.id),s=N(o,r=>r.estimated_value),i=o.filter(ct).length;return`
      <section class="col" data-group="${n(a.group)}" data-stage="${n(a.id)}" role="listitem">
        ...
        <div class="col-body" data-drop="${n(a.id)}">
          ${o.length?o.sort((r,l)=>dt(l).sort-dt(r).sort).map(Hn).join(""):'<p class="col-empty">Nothing here</p>'}
        </div>
      </section>`}).join("")}
  </div>`:w("No opportunities yet.","An enquiry from the website appears here automatically. You can also add one by hand.",{tone:"quiet"})}function Hn(t){let e=dt(t);return`
  <article class="deal${e.level==="overdue"||e.level==="unbooked"?" deal-alarm":""}" draggable="true" data-deal="${n(t.id)}">
    ...
    <div class="deal-foot">
  ...
  </article>`}function Gn(t,e){async function a(s,i,r){let l=Ht.find($=>$.id===s)||{id:s,title:"this opportunity",stage:r};if(l.stage!==i){if(i==="lost")return Qn(s,l,e,r,t);try{await d.setStage(s,i),v(`Moved to ${st[i].name}.`),await e()}catch($){v($.message||"That move could not be saved.","bad");let h=t.querySelector(`[data-move="${CSS.escape(s)}"]`);h&&r&&(h.value=r)}}}t.addEventListener("change",s=>{let i=s.target.closest("[data-move]");if(!i)return;let r=i.dataset.move,l=Ht.find($=>$.id===r)?.stage;a(r,i.value,l)});let o=null;t.addEventListener("dragstart",s=>{let i=s.target.closest("[data-deal]");if(i){o=i.dataset.deal,i.classList.add("is-dragging"),s.dataTransfer.effectAllowed="move";try{s.dataTransfer.setData("text/plain",o)}catch{}}}),t.addEventListener("dragend",s=>{s.target.closest("[data-deal]")?.classList.remove("is-dragging"),t.querySelectorAll(".is-over").forEach(i=>i.classList.remove("is-over")),o=null}),t.addEventListener("dragover",s=>{let i=s.target.closest("[data-drop]");!i||!o||(s.preventDefault(),s.dataTransfer.dropEffect="move",i.classList.contains("is-over")||(t.querySelectorAll(".is-over").forEach(r=>r.classList.remove("is-over")),i.classList.add("is-over")))}),t.addEventListener("drop",s=>{let i=s.target.closest("[data-drop]");if(!i||!o)return;s.preventDefault();let r=o;o=null,a(r,i.dataset.drop,Ht.find(l=>l.id===r)?.stage)})}function Qn(t,e,a,o,s){V({title:"Mark as lost",sub:e.title,width:460,submitLabel:"Mark lost",body:u("lost_reason","Why was it lost?",J("lost_reason","",3,'required placeholder="Price \u2014 a competitor came in 14% below"'),{hint:"Recorded on the timeline. This is the part somebody reads back in six months."}),onSubmit:async l=>{if(!l.lost_reason)throw Object.assign(new Error("Give a reason."),{field:"lost_reason"});await d.setStage(t,"lost",{lostReason:l.lost_reason}),v("Marked lost."),await a()}});let i=s.querySelector(`[data-move="${CSS.escape(t)}"]`),r=new MutationObserver(()=>{document.querySelector(".modal")||(i&&document.contains(i)&&o&&(i.value=o),r.disconnect())});r.observe(document.body,{childList:!0})}function Vn(){let t=Ht.filter(e=>st[e.stage]?.open);return`${n(x(t.length,"open opportunity","open opportunities"))} \xB7 <span class="num">${n(k(N(t,e=>e.estimated_value)))}</span>`}var Fn,Ht,zn,Fa=D(()=>{H();W();P();K();G();ut();Fn="Pipeline",Ht=[];zn=()=>`<button type="button" class="btn btn-sm" data-new-opp>${c.plus(14)}<span>New opportunity</span></button>`});var De={};z(De,{bookFollowUp:()=>le,contactDialog:()=>Xe,convertDialog:()=>ta,logActivity:()=>re,newOpportunity:()=>Ze,projectDialog:()=>ea,quoteDialog:()=>Gt,taskDialog:()=>ce,visitDialog:()=>Qt});async function Ze({me:t,contact:e=null,onDone:a}){let o=await d.profiles();V({title:"New opportunity",sub:e?`For ${e.full_name}`:"A job somebody has asked about",width:620,submitLabel:"Create",body:`
      <div class="field-row">
        ${u("title","What is the job?",j("title","",'required placeholder="Warehouse extension \u2014 3 bays"'),{wide:!0})}
      </div>
      <div class="field-row">
        ${u("contact_name","Contact",j("contact_name",e?.full_name||"",e?"readonly":'placeholder="Tendai Moyo"'))}
        ${u("company","Company",j("company","",'placeholder="Msasa Park Logistics"'))}
      </div>
      <div class="field-row">
        ${u("phone","Phone / WhatsApp",j("phone",e?.phone||"",'placeholder="+263 77 000 0000"'))}
        ${u("email","Email",j("email",e?.email||"",'type="email" placeholder="name@company.co.zw"'))}
      </div>
      <div class="field-row">
        ...
        ${u("source","How did it come in?",O("source",_e.map(s=>[s,Ct[s]]),"phone"))}
      </div>
      <div class="field-row">
        ${u("location","Site",j("location","",'placeholder="Msasa, Harare"'))}
      ...
      <div class="field-row">
        ${u("next_action","Next action",j("next_action","Call and qualify the enquiry","required"))}
        ${u("next_action_due","Due",X("next_action_due",xe(),"required"))}
      </div>
      ...
      ${u("kind","What happened?",O("kind",ba.map(s=>[s,ve[s]]),"call"))}
      ${u("body","Notes",J("body","",4,'required placeholder="Spoke to Tendai. Wants the quotation by Friday."'),{wide:!0})}
      ${u("occurred_at","When",je("occurred_at",qe(new Date)),{hint:"Change this if you are catching up on something from earlier."})}`,onSubmit:async s=>{if(!s.body)throw U("body","Write what happened.");await d.logActivity({opportunity_id:t||null,contact_id:e||null,kind:s.kind,body:s.body,actor_id:a?.id||null,occurred_at:ze(s.occurred_at)||new Date().toISOString()}),v("Logged."),Y(o)}})}async function le({opp:t,me:e,onDone:a}){let o=await d.profiles();V({title:t.next_action_due?"Change the next action":"Book the next action",sub:"Every open opportunity should have one. This is what puts it on the follow-up list.",width:540,submitLabel:"Save",body:`
      ${u("next_action","What needs to happen",j("next_action",t.next_action||"",'required placeholder="Chase the quotation"'),{wide:!0})}
      <div class="field-row">
        ${u("next_action_due","When",X("next_action_due",ot(t.next_action_due)||xe(),"required"))}
      ...
      <div class="field-row">
        ${u("status","Status",O("status",we.map(i=>[i,Nt[i]]),e?.status||"draft"))}
      ...
      <div class="field-row">
        ${u("scheduled_at","When",je("scheduled_at",qe(e?.scheduled_at)||qe(new Date(Date.now()+864e5)),"required"))}
        ${u("owner_id","Who is going",O("owner_id",ie(s),e?.owner_id||a?.id||""))}
      </div>
      ${u("location","Where",j("location",e?.location||t?.location||"",'placeholder="Msasa, Harare"'),{wide:!0})}
      ${u("purpose","Purpose",j("purpose",e?.purpose||"Measure up and assess access",""),{wide:!0})}
      ${i?`
      ...
      ${u("title","What needs doing",j("title",t?.title||"","required"),{wide:!0})}
      <div class="field-row">
        ${u("due_date","Due",X("due_date",ot(t?.due_date)||xe()))}
      ...
      ${u("notes","Notes",J("notes",t.notes||"",2),{wide:!0})}`,onSubmit:async s=>{if(!s.name)throw U("name","A project needs a name.");await d.updateProject(t.id,{name:s.name,status:s.status,owner_id:g(s.owner_id),start_date:g(s.start_date),target_date:g(s.target_date),completed_on:g(s.completed_on),value:Tt(s.value),description:g(s.description),notes:g(s.notes)}),v("Project saved."),Y(a)}})}var Ye,ie,it=D(()=>{H();W();P();ut();Ye=t=>t.charAt(0).toUpperCase()+t.slice(1),ie=(t,e=!0)=>(e?[["","Unassigned"]]:[]).concat(t.map(a=>[a.id,a.full_name]))});var Wa={};z(Wa,{mount:()=>Yn,render:()=>Jn,sub:()=>Xn,title:()=>Kn});async function Jn(t,{me:e}){qt=await d.openOpportunities();let a=qt.filter(ct).sort((l,$)=>q(l.next_action_due)-q($.next_action_due)),o=qt.filter(Ut).sort((l,$)=>new Date(l.created_at)-new Date($.created_at)),s=qt.filter(ke),i=qt.filter(l=>{let $=q(l.next_action_due);return $!==null&&$>0&&$<=14}).sort((l,$)=>q(l.next_action_due)-q($.next_action_due));return`
    ${`
    ...
    <ul class="fu-list">
      ${e.map(o=>`
        <li class="fu">
          <span class="fu-when">${Ce(o.next_action_due)}</span>
    ...
    <div class="filters">
      ...
      <select class="sel sel-inline" id="f-owner" data-f="owner">
        ...
        ${Ga.map(s=>`<option value="${n(s.id)}"${rt.owner===s.id?" selected":""}>${n(s.full_name)}</option>`).join("")}
      </select>
    ...
    <ul class="fu-list">
      ${e.sort(as).map(s=>`
        <li class="fu${s.status==="done"?" is-done":""}">
          <span class="fu-when">${Ce(s.due_date)}</span>
          <div class="fu-main">
    ...
    </ul>`:w(rt.status==="open"?"Nothing outstanding.":"No tasks match that filter.",rt.status==="open"?"Every task on this filter is done.":"",{tone:"ok"});return a+f("",o,{tight:!0})}function ns(t,e,{me:a}){t.addEventListener("change",o=>{let s=o.target.closest("[data-f]");if(!s)return;rt[s.dataset.f]=s.value;let i=document.getElementById("view");i.innerHTML=Qa(a)}),t.addEventListener("click",async o=>{let s=o.target.closest("[data-done]"),i=o.target.closest("[data-reopen]"),r=o.target.closest("[data-edit]");try{if(s)return await d.completeTask(s.dataset.done),v("Completed."),e();if(i)return await d.updateTask(i.dataset.reopen,{status:"open"}),v("Reopened."),e();if(r){let l=Me.find($=>$.id===r.dataset.edit);if(l)return ce({task:l,me:a,onDone:e})}}catch(l){v(l.message||"That could not be saved.","bad")}})}function ss(){let t=Me.filter(a=>a.status==="open"),e=t.filter(a=>a.due_date&&q(a.due_date)<0).length;return e?`<span class="sub-alarm">${c.alert(14)}${n(x(e,"task"))} overdue</span>`:`${n(x(t.length,"open task"))}`}var ts,Me,rt,Ga,as,os,za=D(()=>{H();W();P();K();G();ut();it();ts="Tasks",Me=[],rt={status:"open",owner:"all"},Ga=[];as=(t,e)=>t.due_date?e.due_date?t.due_date<e.due_date?-1:t.due_date>e.due_date?1:0:-1:1;os=()=>`<button type="button" class="btn btn-sm" data-new-task-global>${c.plus(14)}<span>New task</span></button>`});var Ja={};z(Ja,{actions:()=>ds,mount:()=>ls,render:()=>rs,sub:()=>cs,title:()=>is});async function rs(){return Vt=await d.contacts(),`
    <div class="filters">
      <div class="search">
        ${c.search(15)}
    ...
    <div data-list>${Ka(Vt)}</div>`}function Ka(t){return t.length?f("",pt(`
  ...
  <ul class="mini files">
    ...
    <ul class="mini">
      ${a.map(h=>`<li>
        <a href="#/opportunity/${n(h.id)}">
          <span class="mini-main">${n(h.title)} ${jt(h)}</span>
    ...
    <div class="grid grid-opp">
    ...
    </div>`}function hs(t,e,{me:a}){t.addEventListener("click",o=>{if(o.target.closest("[data-edit-contact]"))return Xe({contact:E,onDone:e});if(o.target.closest("[data-new-opp-for]"))return Ze({me:a,contact:E,onDone:e})}),Kt(t,{contact_id:E.id},a,e)}function fs(){return E?[E.companies?.name,E.job_title].filter(Boolean).map(n).join(" \xB7 "):""}var us,E,tn=D(()=>{H();P();K();G();it();Ne();us=()=>E?.full_name||"Contact",E=null});var en={};z(en,{editOpportunity:()=>ys});async function ys({opp:t,me:e,onDone:a}){let o=await d.profiles();V({title:"Edit opportunity",sub:t.ref,width:620,submitLabel:"Save",body:`
      ${u("title","What is the job?",j("title",t.title,"required"),{wide:!0})}
      <div class="field-row">
        ...
        ${u("source","Source",O("source",_e.map(s=>[s,Ct[s]]),t.source))}
      </div>
      <div class="field-row">
        ${u("location","Site",j("location",t.location||""))}
      ...
      ${u("description","What do they want?",J("description",t.description||"",4),{wide:!0})}`,onSubmit:async s=>{if(!s.title)throw U("title","Give the job a name.");await d.updateOpportunity(t.id,{title:s.title,service:g(s.service),source:s.source,location:g(s.location),estimated_value:Tt(s.estimated_value),owner_id:g(s.owner_id),priority:s.priority,site_visit_required:!!s.site_visit_required,description:g(s.description)}),v("Saved."),Y(a)}})}var $s,an=D(()=>{H();W();P();ut();$s=t=>t.charAt(0).toUpperCase()+t.slice(1)});var nn={};z(nn,{mount:()=>_s,render:()=>bs,sub:()=>ws,title:()=>gs});async function bs(t,{me:e}){if(p=await d.opportunity(t),!p)return w("That opportunity no longer exists.","It may have been deleted.",{tone:"quiet"});let[a,o,s,i,r,l]=await Promise.all([d.activityFor(t),d.quotesFor(t),d.visitsFor(t),d.tasksFor(t),d.filesFor("opportunity_id",t),d.projectForOpportunity(t)]);Pe={activity:a,quotes:o,visits:s,tasks:i,files:r,project:l,me:e};let $=dt(p),h=$.level==="overdue"||$.level==="unbooked",R={full_name:p.contact_name,phone:p.contact_phone,whatsapp:p.contact_whatsapp,email:p.contact_email},Z=`
  <section class="opp-head${h?" opp-head-alarm":""}">
      ...
      <div class="opp-next-body">
        ...
        ${p.next_action||p.next_action_due?`
          ...
          <p class="opp-next-meta">
            ...
            <strong>${n(ct(p)?Ae(p.next_action_due):A(p.next_action_due))}</strong>
          </p>`:xt(p)?`
          <p class="opp-next-text">Nobody has booked a next action on this opportunity.</p>
          <p class="opp-next-meta">It is open, it has a value on it, and it is on nobody's list.</p>`:`<p class="opp-next-text">${n(st[p.stage].name)}${p.decided_at?" on "+n(Ve(p.decided_at)):""}.</p>
    ...
    <dl class="kv">
      ...
      <div><dt>Came in by</dt><dd>${Dt(p.source)}</dd></div>
    ...
    <ul class="mini">
      ${et.map(b=>`<li>
       ...
       <button type="button" class="btn btn-sm" data-convert>${c.briefcase(14)}<span>Open a project</span></button>`),Re=f("Activity",`
    <div class="log-add">
    ...
    ${Z}
    <div class="grid grid-opp">
      <div class="col-wide">${tt}${Re}</div>
      <div class="col-side">${I}${Mt}${B}${nt}${At}${zt(Pe.files)}</div>
    </div>`}function _s(t,e,{me:a}){let o=()=>e();t.addEventListener("change",async s=>{let i=s.target.closest("[data-stage]");if(!i)return;let r=i.value;if(r!==p.stage){if(r==="lost"){let{dialog:l,field:$,textarea:h,fieldError:R}=await Promise.resolve().then(()=>(ut(),Ua));l({title:"Mark as lost",sub:p.title,submitLabel:"Mark lost",width:460,body:$("lost_reason","Why was it lost?",h("lost_reason","",3,"required")),onSubmit:async Z=>{if(!Z.lost_reason)throw R("lost_reason","Give a reason.");await d.setStage(p.id,"lost",{lostReason:Z.lost_reason}),v("Marked lost."),await o()}}),i.value=p.stage;return}try{await d.setStage(p.id,r),v(`Moved to ${st[r].name}.`),await o()}catch(l){v(l.message||"That could not be saved.","bad"),i.value=p.stage}}}),t.addEventListener("click",async s=>{let i=h=>s.target.closest(h);if(i("[data-followup]"))return le({opp:p,me:a,onDone:o});if(i("[data-log]"))return re({opportunityId:p.id,contactId:p.contact_id,me:a,onDone:o});if(i("[data-new-quote]"))return Gt({opp:p,me:a,onDone:o});if(i("[data-new-visit]"))return Qt({opp:p,me:a,onDone:o});if(i("[data-new-task]"))return ce({opp:p,me:a,onDone:o});if(i("[data-convert]"))return ta({opp:p});let r=i("[data-quote]");if(r)return Gt({opp:p,quote:Pe.quotes.find(h=>h.id===r.dataset.quote),me:a,onDone:o});let l=i("[data-visit]");if(l)return Qt({opp:p,visit:Pe.visits.find(h=>h.id===l.dataset.visit),me:a,onDone:o});let $=i("[data-done]");if($){try{await d.completeTask($.dataset.done),v("Task completed."),await o()}catch(h){v(h.message,"bad")}return}if(i("[data-edit-opp]")){let{editOpportunity:h}=await Promise.resolve().then(()=>(an(),en));return h({opp:p,me:a,onDone:o})}}),Kt(t,{opportunity_id:p.id},a,o)}function ws(){return p?`${n(p.company_name||p.contact_name||"")} \xB7 ${n(p.service||st[p.stage].name)}`:""}var p,Pe,gs,sn=D(()=>{H();W();P();K();G();ut();it();Ne();p=null,Pe={},gs=()=>p?.title||"Opportunity"});var rn={};z(rn,{mount:()=>ks,render:()=>xs,sub:()=>Ss,title:()=>vs});async function xs(t,{me:e}){return Jt=await d.quotes(),on()}function on(){let t=_t==="all"?Jt:_t==="live"?Jt.filter(o=>o.status==="sent"||o.status==="discussed"):Jt.filter(o=>o.status===_t),e=`
    <div class="filters">
      ...
      <select class="sel sel-inline" id="q-filter" data-f>
        ...
        ${we.map(o=>`<option value="${o}"${_t===o?" selected":""}>${n(Nt[o])}</option>`).join("")}
      </select>
    ...
    </table>`):w(_t==="live"?"No quotations are out.":"Nothing matches that filter.",_t==="live"?"Everything issued has been decided.":"",{tone:"ok"});return e+f("",a,{tight:!0})}function ks(t,e,{me:a}){t.addEventListener("change",o=>{o.target.closest("[data-f]")&&(_t=o.target.value,document.getElementById("view").innerHTML=on())}),t.addEventListener("click",async o=>{let s=o.target.closest("[data-edit]");if(!s)return;let i=Jt.find(l=>l.id===s.dataset.edit);if(!i)return;let r=await d.opportunity(i.opportunity_id);Gt({opp:r,quote:i,me:a,onDone:e})})}function Ss(){let t=Jt.filter(e=>e.status==="sent"||e.status==="discussed");return`${n(x(t.length,"quotation"))} awaiting a decision \xB7 <span class="num">${n(k(N(t,e=>e.amount)))}</span>`}var vs,Jt,_t,ln=D(()=>{H();W();P();K();G();it();vs="Quotations",Jt=[],_t="live"});var cn={};z(cn,{mount:()=>qs,render:()=>Ts,sub:()=>As,title:()=>Es});async function Ts(t,{me:e}){Yt=await d.visits();let a=Yt.filter(i=>i.status==="scheduled"&&q(i.scheduled_at)>=0).sort((i,r)=>new Date(i.scheduled_at)-new Date(r.scheduled_at)),o=Yt.filter(i=>i.status==="scheduled"&&q(i.scheduled_at)<0).sort((i,r)=>new Date(r.scheduled_at)-new Date(i.scheduled_at)),s=Yt.filter(i=>i.status!=="scheduled").sort((i,r)=>new Date(r.scheduled_at)-new Date(i.scheduled_at)).slice(0,30);return`
    ...
    </table>`),{tight:!0,note:`${x(e.length,"project")} \xB7 ${k(N(e,a=>a.value))}`}):f(t,w("Nothing here.","",{tone:"quiet"}),{tight:!0})}function js(){let t=de.filter(e=>["planning","in_progress","on_hold"].includes(e.status));return`${n(x(t.length,"active project"))} \xB7 <span class="num">${n(k(N(t,e=>e.value)))}</span>`}var Ls,de,mn=D(()=>{H();W();P();K();G();Ls="Projects",de=[]});var hn={};z(hn,{mount:()=>Ms,render:()=>Os,sub:()=>Ns,title:()=>Ds});async function Os(t,{me:e}){if(_=await d.project(t),!_)return w("That project no longer exists.","",{tone:"quiet"});let[a,o]=await Promise.all([d.activityForProject(t),d.filesFor("project_id",t)]),i=`
    ...
    </div>`}function Ms(t,e,{me:a}){t.addEventListener("click",o=>{if(o.target.closest("[data-edit-project]"))return ea({project:_,me:a,onDone:e})}),Kt(t,{project_id:_.id},a,e)}function Ns(){return _?[_.companies?.name,Pt[_.status]].filter(Boolean).map(n).join(" \xB7 "):""}var Ds,_,fn=D(()=>{H();W();P();K();G();it();Ne();Ds=()=>_?.name||"Project",_=null});var $n={};z($n,{mount:()=>Rs,render:()=>Us,sub:()=>Is,title:()=>Ps});async function Us(t,{me:e}){if(e?.role!=="admin")return f("",w("This screen is for administrators.","Ask Mr Murandu if you need access to it.",{tone:"quiet"}),{tight:!0});[sa,Ue]=await Promise.all([d.profiles(),d.enquiries(60)]);let a=f("People",pt(`
    <table class="tbl tbl-rows">
    ...
    <p class="scope">Deactivating somebody keeps everything they did \u2014 their calls, their
      ...
      take the history with it, which is why this screen does not offer it.</p>`),s=f("Website enquiry log",Ue.length?pt(`
    <table class="tbl tbl-rows">
      <thead><tr>
    ...
    </table>`):w("No website enquiries yet.","Everything submitted on kingson-engineering.vercel.app lands here and in the pipeline.",{tone:"quiet"}),{tight:!0,note:`${x(Ue.length,"submission")} \xB7 the last sixty`});return`${a}${o}${s}`}function Rs(t,e,{me:a}){t.addEventListener("change",async o=>{let s=o.target.closest("[data-role]");if(s)try{await y.update("profiles",L("id",s.dataset.role),{role:s.value}),v("Role updated."),await e()}catch(i){v(i.message||"That could not be changed.","bad"),await e()}}),t.addEventListener("click",async o=>{let s=o.target.closest("[data-active]");if(s)try{await y.update("profiles",L("id",s.dataset.active),{active:s.dataset.to==="true"}),v(s.dataset.to==="true"?"Reactivated.":"Deactivated."),await e()}catch(i){v(i.message||"That could not be changed.","bad")}})}function Is(){return`${n(x(sa.length,"person","people"))}`}var Ps,sa,Ue,yn=D(()=>{H();P();K();G();ut();Ps="Settings",sa=[],Ue=[]});He();W();var at=null,Tn=new Set,Ee=()=>at;var wa=()=>!!(Fe()?.access_token&&at);var Ge=()=>Tn.forEach(t=>t(at));function qn(t){try{let e=t.split(".")[1],a=atob(e.replace(/-/g,"+").replace(/_/g,"/"));return JSON.parse(a).sub||null}catch{return null}}async function va(){let t=Fe(),e=t?.access_token?qn(t.access_token):null;if(!e)return at=null,null;let o=(await y.select("profiles",`select=*&id=eq.${e}`))[0]||null;if(!o)throw at=null,Lt(null),new Error("This account has no profile in the CRM. Ask an administrator to set one up.");if(!o.active)throw at=null,Lt(null),new Error("This account has been deactivated.");return at=o,at}async function xa(){if(!ua())return at=null,null;try{await va()}catch{at=null}return Ge(),at}async function ka(t,e){return await fa(t,e),await va(),Ge(),_a(y).catch(()=>{}),at}async function Sa(){await $a(),at=null,Ge()}H();W();P();G();var On=[{key:"dashboard",href:"#/",label:"Dashboard",ic:"dashboard"},{key:"pipeline",href:"#/pipeline",label:"Pipeline",ic:"pipeline"},{key:"followups",href:"#/followups",label:"Follow-ups",ic:"bell",badge:!0},{key:"tasks",href:"#/tasks",label:"Tasks",ic:"task"},{key:"contacts",href:"#/contacts",label:"Contacts",ic:"users"},{key:"quotes",href:"#/quotes",label:"Quotations",ic:"doc"},{key:"visits",href:"#/visits",label:"Site visits",ic:"pin"},{key:"projects",href:"#/projects",label:"Projects",ic:"briefcase"},{key:"settings",href:"#/settings",label:"Settings",ic:"shield",admin:!0}];function Ke(t,e,{overdue:a=0}={}){return`
  <div class="rail-top">
    <a class="mark" href="#/">
  ...
  </div>`;K();ut();P();var Xt=document.getElementById("app"),oa=document.getElementById("rail"),ue=document.getElementById("topbar"),yt=document.getElementById("view"),ca=document.getElementById("scrim"),Zt=document.getElementById("gate"),ia={dashboard:()=>Promise.resolve().then(()=>(Ia(),Ra)),pipeline:()=>Promise.resolve().then(()=>(Fa(),Ba)),followups:()=>Promise.resolve().then(()=>(Ha(),Wa)),tasks:()=>Promise.resolve().then(()=>(za(),Va)),contacts:()=>Promise.resolve().then(()=>(Ya(),Ja)),contact:()=>Promise.resolve().then(()=>(tn(),Xa)),opportunity:()=>Promise.resolve().then(()=>(sn(),nn)),quotes:()=>Promise.resolve().then(()=>(ln(),rn)),visits:()=>Promise.resolve().then(()=>(dn(),cn)),projects:()=>Promise.resolve().then(()=>(mn(),un)),project:()=>Promise.resolve().then(()=>(fn(),hn)),settings:()=>Promise.resolve().then(()=>(yn(),$n))},Bs={opportunity:"pipeline",contact:"contacts",project:"projects"},lt=gn(),ra=0;function gn(){let t=(location.hash||"#/").replace(/^#\/?/,""),[e,a]=t.split("/");return e?ia[e]?{key:e,arg:a||null}:{key:"dashboard",arg:null}:{key:"dashboard",arg:null}}async function da(){try{ra=(await d.openOpportunities()).filter(ct).length}catch{}}var pe=0;function Fs(){let t=yt.cloneNode(!1);return delete t.dataset.view,yt.replaceWith(t),yt=t,t}async function he(){if(!wa())return me();let t=++pe,e=Ee(),a=Bs[lt.key]||lt.key;oa.innerHTML=Ke(a,e,{overdue:ra}),pa();let o;try{o=await(ia[lt.key]||ia.dashboard)()}catch{ue.innerHTML=Le("Kingson"),yt.innerHTML=Je("That screen could not be loaded. Check the connection and try again.");return}if(t===pe){ue.innerHTML=Le(typeof o.title=="function"?o.title(lt.arg):o.title,""),Fs(),yt.innerHTML=Ca(4),yt.dataset.view=lt.key;try{let s=await o.render(lt.arg,{me:e,rerender:la});if(t!==pe)return;yt.innerHTML=s,ue.innerHTML=Le(typeof o.title=="function"?o.title(lt.arg):o.title,typeof o.sub=="function"?await o.sub(lt.arg):o.sub||"",typeof o.actions=="function"?o.actions(lt.arg,e):""),o.mount?.(yt,la,{me:e,arg:lt.arg})}catch(s){if(t!==pe)return;console.error("[kingson] view failed",lt.key,s),yt.innerHTML=Je(s?.message||"That screen could not be loaded.")}da().then(()=>{t===pe&&(oa.innerHTML=Ke(a,Ee(),{overdue:ra}))})}}async function la(){let t=window.scrollY;await he(),window.scrollTo(0,t)}function me(t=""){Xt.hidden=!0,Zt.hidden=!1,Zt.innerHTML=La(t);let e=Zt.querySelector("#signin-form"),a=e.querySelector("[data-signin]"),o=e.querySelector(".signin-err");e.querySelector("#si-email").focus(),e.addEventListener("submit",async s=>{s.preventDefault();let i=e.querySelector("#si-email").value.trim(),r=e.querySelector("#si-password").value;if(o.hidden=!0,!i||!r){o.textContent="Enter your email address and password.",o.hidden=!1;return}a.disabled=!0,a.textContent="Signing in\u2026";try{await ka(i,r),Zt.hidden=!0,Zt.innerHTML="",Xt.hidden=!1,await da(),await he()}catch(l){o.textContent=l?.status===400?"That email address and password do not match an account.":l?.message||"Sign-in failed.",o.hidden=!1,a.disabled=!1,a.textContent="Sign in",e.querySelector("#si-password").select()}})}var Ws=()=>{Xt.classList.add("rail-open"),ca.hidden=!1,oa.querySelector(".rail-link")?.focus(),ue.querySelector("[data-rail-open]")?.setAttribute("aria-expanded","true")},pa=()=>{Xt.classList.remove("rail-open"),ca.hidden=!0,ue.querySelector("[data-rail-open]")?.setAttribute("aria-expanded","false")};document.addEventListener("click",async t=>{if(t.target.closest("[data-rail-open]"))return Ws();if(t.target===ca||t.target.closest(".rail-link"))return pa();if(t.target.closest("[data-signout]")){await Sa(),location.hash="#/",me();return}if(t.target.closest("[data-retry]"))return he();let e=Ee();if(t.target.closest("[data-new-opp]")){let{newOpportunity:a}=await Promise.resolve().then(()=>(it(),De));return a({me:e})}if(t.target.closest("[data-new-contact]")){let{contactDialog:a}=await Promise.resolve().then(()=>(it(),De));return a({onDone:o=>{location.hash=`#/contact/${o.id}`}})}if(t.target.closest("[data-new-task-global]")){let{taskDialog:a}=await Promise.resolve().then(()=>(it(),De));return a({me:e,onDone:la})}});document.addEventListener("keydown",t=>{t.key==="Escape"&&Xt.classList.contains("rail-open")&&pa()});addEventListener("hashchange",()=>{lt=gn(),he().then(()=>{yt.focus({preventScroll:!0}),scrollTo(0,0)})});addEventListener("storage",t=>{t.key==="kingson-crm/session/v1"&&!t.newValue&&me("Signed out in another tab.")});(async function(){if(document.getElementById("boot")?.remove(),!await xa())return me();Zt.hidden=!0,Xt.hidden=!1,await da(),await he()})().catch(t=>{console.error("[kingson] boot failed",t),me("Something went wrong starting the application. Reload the page.")});export{n as esc,la as softRender,v as toast};
